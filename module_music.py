...
#  ("killed_by_vaegir", "killed_by_vaegir.ogg", mtf_persist_until_finished|mtf_culture_2|mtf_sit_killed, 0),
  ...
  #oim
  ("oim_ambushed_by_neutral", "oim_ambushed_by_neutral.ogg", mtf_sit_ambushed|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight),
  ("oim_calm_night_1", "oim_calm_night_2.ogg", mtf_sit_night, mtf_sit_town|mtf_sit_tavern|mtf_sit_travel),  
  ("oim_captured", "oim_capture.ogg", mtf_persist_until_finished, 0),
  ("oim_crazy_battle_music", "oim_crazy_battle_music.ogg", mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed),  
  ("oim_defeated_by_neutral", "oim_defeated_by_neutral.ogg",mtf_persist_until_finished|mtf_sit_killed, 0),
  ("oim_defeated_by_neutral_3", "oim_defeated_by_neutral_3.ogg", mtf_persist_until_finished|mtf_sit_killed, 0),
  ("oim_encounter_hostile_nords", "oim_encounter_hostile_nords.ogg", mtf_persist_until_finished|mtf_sit_encounter_hostile, 0),
  ("oim_escape", "oim_escape.ogg", mtf_persist_until_finished, 0),
  ("oim_enter_the_juggernaut", "oim_enter_the_juggernaut.ogg", mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed),    
  ("oim_fight_as_khergit", "oim_fight_as_khergit.ogg", mtf_culture_3|mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed, mtf_culture_all),
  ("oim_fight_as_nord", "oim_fight_as_nord.ogg", mtf_culture_4|mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed, mtf_culture_all),
  ("oim_killed_by_khergit", "oim_killed_by_khergit.ogg", mtf_persist_until_finished|mtf_culture_3|mtf_sit_killed, 0),
  ("oim_killed_by_swadian", "oim_killed_by_swadian.ogg", mtf_persist_until_finished|mtf_culture_1|mtf_sit_killed, 0),
  ("oim_lords_hall_khergit", "oim_lords_hall_khergit.ogg", mtf_culture_3|mtf_sit_travel, mtf_sit_town|mtf_sit_night|mtf_sit_tavern|mtf_culture_all),
  ("oim_lords_hall_nord", "oim_lords_hall_nord.ogg", mtf_sit_travel, mtf_sit_town|mtf_sit_night|mtf_sit_tavern),
  ("oim_mount_and_blade_title_screen", "oim_mount_and_blade_title_screen.ogg", mtf_sit_main_title|mtf_start_immediately, 0),  
  ("oim_neutral_infiltration", "oim_neutral_infiltration.ogg", mtf_sit_town_infiltrate, 0),
  ("oim_retreat", "oim_retreat.ogg", mtf_persist_until_finished|mtf_sit_killed, 0),
  ("oim_town_neutral", "oim_town_neutral.ogg", mtf_sit_town|mtf_sit_travel, mtf_sit_tavern|mtf_sit_night),
  ("oim_town_nord", "oim_town_nord.ogg", mtf_culture_4|mtf_sit_town|mtf_sit_travel, mtf_sit_tavern|mtf_sit_night|mtf_culture_all),
  ("oim_tragic_village", "oim_tragic_village.ogg", mtf_sit_travel, mtf_sit_town|mtf_sit_night|mtf_sit_tavern),
  ("oim_victorious_evil", "oim_victorious_evil.ogg", mtf_persist_until_finished, 0),
  ("oim_victorious_swadian", "oim_victorious_swadian.ogg", mtf_persist_until_finished|mtf_culture_2|mtf_sit_victorious, 0),
