...
multiplayer_server_drowning = (   # Drowning and wet powder script Thank you Napoleonic Wars
  1.1, 0, 0, [(multiplayer_is_server)],
  [
    (set_fixed_point_multiplier, 100),
    (try_for_agents, ":cur_agent"),
      (agent_is_active,":cur_agent"),
      ...
      (try_begin),
        (lt,":cur_z",":test_water_level"), #Remove ammo if bullets and in water
        (assign, ":agent_has_bullets", 0),
        (try_for_range, ":agent_slot_no", 0, 4), #should be 0-4
          (agent_get_item_slot, ":agent_item_slot_id", ":cur_agent", ":agent_slot_no"),
          (call_script, "script_get_agent_ammo_type", ":agent_item_slot_id"),
          (assign, ":quiver_type", reg0), #-1 no, #1 bullets, #2 arrows #3 grenades
          (eq, ":quiver_type", 1),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (agent_deliver_damage_to_agent, ":cur_agent", ":cur_agent", 1,"itm_no_item"), #try others
          (try_begin),
            ...
            (else_try),
              (call_script,"script_multiplayer_server_play_sound_at_position","snd_man_grunt"),
            (try_end),
          (try_end),
        (else_try),
      ...
      (else_try),
        ...
        (try_begin), # comming up.
          ...
          (agent_is_human,":cur_agent"),
          (copy_position,pos60,pos16),
          (call_script,"script_multiplayer_server_play_sound_at_position","snd_man_breath_hard"),
        (try_end),
    ...
    [
      ...
      (1, 0, 0, [],
       [
        ...
        (try_for_range, ":player_no", 1, ":end_cond"),
          (player_is_active, ":player_no"),
...
##  ),
  ...
  ###############################################
    ...
    #Defend VIP Spawns
    (88,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (89,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (90,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (91,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (92,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (93,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (94,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (95,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (96,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (97,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (98,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (99,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (100,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (101,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (102,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (103,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (104,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (105,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (106,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (107,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    
    #Escort VIP Spawns
    (108,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (109,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (110,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (111,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (112,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (113,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (114,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (115,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (116,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (117,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (118,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (119,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),

    #Escort VIP Destination Only Points
    (120,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (121,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (122,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (123,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (124,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (125,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (126,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    (127,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
    ...
    [      
        ...
        (agent_set_max_hit_points, ":agent_no", 370), # default 150 (last modded was 310) BEFORE KEY MOD: 425
        (agent_set_damage_modifier, ":agent_no", 170), # default 130 (last modded was 160) BEFORE KEY MOD: 200
      (else_try),
        (eq, ":agent_team_no", 1), # enemies
        (eq, "$g_multiplayer_ccoop_wave_no", 20), # == wave 20
        (agent_set_max_hit_points, ":agent_no", 320), # default 150 (last modded was 260) BEFORE KEY MOD: 325
        (agent_set_damage_modifier, ":agent_no", 160), # default 130 (last modded was 150) BEFORE KEY MOD: 180
      (else_try),
        (eq, ":agent_team_no", 1), # enemies
        (eq, "$g_multiplayer_ccoop_wave_no", 10), # == wave 10
        (agent_set_max_hit_points, ":agent_no", 270), # default 150 (last modded was 210) BEFORE KEY MOD: 275
        (agent_set_damage_modifier, ":agent_no", 140), # default 130 (last modded was 150) BEFORE KEY MOD: 160
      (else_try),
        (eq, ":agent_team_no", 1), # enemies
        (eq, "$g_multiplayer_ccoop_wave_no", 9), # == wave 9
        (agent_set_max_hit_points, ":agent_no", 220), # default 150 (last modded was 200) BEFORE KEY MOD: 275
        (agent_set_damage_modifier, ":agent_no", 140), # default 130 (last modded was 150) BEFORE KEY MOD: 160
      (else_try),
			(eq, ":agent_team_no", 1), # enemies
			(gt, "$g_multiplayer_ccoop_wave_no", 20), # wave++
			(agent_set_max_hit_points, ":agent_no", 315), # default 150 (last modded was 160)
			(agent_set_damage_modifier, ":agent_no", 155), # default 130 (last modded was 150)
		(else_try),
			(eq, ":agent_team_no", 1), # enemies
			(gt, "$g_multiplayer_ccoop_wave_no", 10), # wave+
			(agent_set_max_hit_points, ":agent_no", 265), # default 175 (last modded was 235)
			(agent_set_damage_modifier, ":agent_no", 145), # default 150 (last modded was 140)
		(try_end),
      #Friendly buffs
      # (assign, ":friendly_health_mod", 120),
      # (assign, ":friendly_health_mod", 110),
      #  (try_begin),
      #     (eq, ":agent_team_no", 0), # friendlies
      #     (eq, "$g_multiplayer_ccoop_wave_no", 10), # == wave 10
      #     (agent_set_max_hit_points, ":agent_no", 270), # default 150 (last modded was 210) BEFORE KEY MOD: 275
      #     (agent_set_damage_modifier, ":agent_no", 140), # default 130 (last modded was 150) BEFORE KEY MOD: 160
      #  (else_try),
      ...
      #    (eq, ":agent_team_no", 0), # friendlies
      #    (gt, "$g_multiplayer_ccoop_wave_no", 20), # wave++
      #    (agent_set_max_hit_points, ":agent_no", 120), # default 150 (last modded was 160)
      #    (agent_set_damage_modifier, ":agent_no", 110), # default 130 (last modded was 140)
      #  (else_try),
      #    (eq, ":agent_team_no", 0), # friendlies
      #    (gt, "$g_multiplayer_ccoop_wave_no", 10), # wave+
      #    (agent_set_max_hit_points, ":agent_no", 110), # default 175 (last modded was 175)
      #    (agent_set_damage_modifier, ":agent_no", 105), # default 150 (last modded was 140)
      #  (try_end),

      (try_begin), #Set players horses/damage
        (neg|agent_is_non_player, ":agent_no"),
        (agent_is_active, ":agent_no"),
        (agent_is_human, ":agent_no"),
        (eq, ":agent_team_no", 0),
        (agent_set_max_hit_points, ":agent_no", "$g_player_health_mod"),
        (agent_set_damage_modifier, ":agent_no", "$g_player_damage_mod"),
        (agent_get_horse, ":hero_players_horse", ":agent_no"),
        (try_begin),
          (neq, ":hero_players_horse", -1),
          (agent_set_max_hit_points, ":hero_players_horse", "$g_player_horse_health"),
        (try_end),
        #(agent_get_horse, ":player_horse", ":agent_no"),
        #(try_begin),
          #(neq, ":player_horse", -1),
          #(agent_set_max_hit_points, ":player_horse", "$g_vip_horse_health"),
        #(try_end),
      (try_end),

      (assign, ":is_reinforcement", 0),
      #is Reinforcement agent?
      (try_begin),
        (multiplayer_is_server),
        (eq, "$g_reinforcement_spawning", 1), #May need to turn off
        (agent_is_non_player, ":agent_no"),
        (agent_is_human, ":agent_no"),
        (agent_get_troop_id, ":agent_troop_id", ":agent_no"),
        (call_script, "script_dy_is_agent_reinforcement", ":agent_troop_id"),
        (assign, ":is_reinforcement_agent", reg14),
        (eq, ":is_reinforcement_agent", 1),
        (agent_set_slot, ":agent_no", slot_agent_is_reinforcement_agent, 1),
        (agent_ai_set_always_attack_in_melee, ":agent_no", 1),
        (agent_get_horse, ":reinforcement_agent_horse", ":agent_no"),
        (try_begin),
          (neq, ":reinforcement_agent_horse", -1),
          (agent_set_max_hit_points, ":reinforcement_agent_horse", "$g_reinforcement_horse_health"),
        (try_end),
        (agent_set_max_hit_points, ":agent_no", "$g_reinforcement_health_mod"),
        (agent_set_damage_modifier, ":agent_no", "$g_reinforcement_damage_mod"),
        (assign, ":is_reinforcement", 1),
      (try_end),

      (try_begin),
        (multiplayer_is_server),
        (eq, "$g_is_boss_round", 0),
        (gt, "$g_chosen_quest_type", -1),
        (agent_is_non_player, ":agent_no"),
        (eq, ":is_reinforcement", 0),
        #(agent_is_active, ":agent_no"),
        #(agent_is_alive, ":agent_no"),
        (agent_is_human, ":agent_no"),
        (agent_get_troop_id, ":agent_troop_id", ":agent_no"),
        (call_script, "script_dy_is_agent_a_hero", ":agent_troop_id"),
        (assign, ":is_hero_agent", reg14),
        (eq, ":is_hero_agent", 1),
        
        (assign, "$g_agent_hero_global_id_1", ":agent_no"), # Set global agent hero
        (agent_get_horse, ":hero_vip_horse", ":agent_no"),
        (try_begin),
          (neq, ":hero_vip_horse", -1),
          (agent_set_max_hit_points, ":hero_vip_horse", "$g_vip_horse_health"),
        (try_end),
        (agent_set_max_hit_points, "$g_agent_hero_global_id_1", "$g_vip_hero_health_mod"),
        (agent_set_damage_modifier, "$g_agent_hero_global_id_1", "$g_vip_hero_damage_mod"),
      (try_end),

      (try_begin), #Set all player horses to strays
        (neg|agent_is_human, ":agent_no"),
        (agent_set_slot, ":agent_no", slot_agent_is_stray_horse, 1), #is a player horse
        (store_mission_timer_a, ":cur_time"),
        (agent_set_slot, ":agent_no", slot_agent_stray_horse_timer, ":cur_time"), #set time
        (assign, reg32, ":cur_time"),
      (try_end),
      (try_begin), #Set Ranged to Charge
        (agent_is_active, ":agent_no"),
        (agent_is_non_player, ":agent_no"),
        (eq, ":agent_team_no", 1),
        (agent_is_human, ":agent_no"),
        (agent_get_ammo, ":agent_ammo_amt", ":agent_no", 0),
        (gt, ":agent_ammo_amt", 0), #Does agent have ammo?
        (agent_ai_set_always_attack_in_melee, ":agent_no", 1),
        #(display_message, "@SET RANGED AGENT ALWAYS ATTACK MELEE"),
      (try_end),

      (try_begin), #Daimyo Check Agent Spawned and add to Friendly Global Count
         (multiplayer_is_server),
         (agent_is_human, ":agent_no"),
         (eq, ":agent_team_no", 0),
      ...
      (try_begin),
         (neg|agent_is_non_player, ":agent_no"),
         (val_add, "$g_global_alive_player_count", 1),
      (try_end),
      (try_begin), #Daimyo Check Agent Spawned and add to Enemy Global Count
         (multiplayer_is_server),
         (agent_is_non_player, ":agent_no"),
         (agent_is_human, ":agent_no"),
         (eq, ":agent_team_no", 1),
      ...
      (try_begin),
       ...
       (else_try),
         (eq, "$g_chosen_quest_type", 3), #Defend friendly hero make AI static
         (entry_point_get_position, pos23, "$g_vip_agent_hero_spawn_point"),
         (agent_set_scripted_destination, "$g_agent_hero_global_id_1", pos23),
       (try_end),
       (assign, "$g_vip_agent_spawned", 1), 
       #(display_message, "@VIP HERO SPAWNED"),
       #(display_message, "@VIP HERO SPAWNED"),
      (try_end),
      #Is hero guard?
      (try_begin),
        (multiplayer_is_server),
        (eq, ":is_reinforcement", 0),
        #(agent_slot_eq, ":agent_no", slot_agent_is_reinforcement_agent, 0),
        (eq, "$g_is_boss_round", 0),
        (gt, "$g_chosen_quest_type", -1),
        (agent_is_non_player, ":agent_no"),
        #(agent_is_active, ":agent_no"),
        ...
        (agent_is_human, ":agent_no"),
        (agent_get_troop_id, ":agent_troop_id", ":agent_no"),
        (call_script, "script_dy_is_agent_hero_guard", ":agent_troop_id"),
        (assign, ":is_hero_guard", reg15),
        (eq, ":is_hero_guard", 1),
        (agent_set_slot, ":agent_no", slot_agent_is_hero_guard, 1),
        (val_add, "$g_hero_guards_quest", 1), 
        (troop_set_slot, "trp_array_agents", "$g_hero_guards_quest", ":agent_no"),#Build Guard Array
        (call_script, "script_dy_get_vip_guardpos", ":agent_no"),
        (agent_set_max_hit_points, ":agent_no", "$g_hero_guard_health_mod"),
        (agent_set_damage_modifier, ":agent_no", "$g_hero_guard_damage_mod"),
        #(display_message, "@HERO GUARD SPAWNED"),
        #(call_script, "script_dy_assign_guards_to_global", ":agent_no"), #Set guard to global self
      (try_end),
		]),
      ...
      (str_store_string, s20, "str_server_announcement_1"),  
      (multiplayer_send_string_to_player, ":player_no", multiplayer_event_show_server_message, s20),
      
      #(player_set_gold, ":player_no", 500000, multi_max_gold_that_can_be_stored), #DEBUG
      
      (player_set_slot, ":player_no", slot_player_current_intro_message, 1),
      (player_set_slot, ":player_no", slot_player_received_intro_messages, 0),
      (store_mission_timer_a, ":cur_time"),
      (player_set_slot, ":player_no", slot_player_intro_messages_timer, ":cur_time"),
		...
		[
			...
			(call_script, "script_multiplayer_server_before_mission_start_common"),
      (assign, "$g_start_server_message_tick", 1), #DY start server message tick
			(call_script, "script_multiplayer_init_mission_variables"),
			(call_script, "script_multiplayer_remove_destroy_mod_targets"),
			(call_script, "script_multiplayer_remove_headquarters_flags"),
		]),
		...
		[
			...
			(assign, "$g_multiplayer_squad_size", 16), # constant size for coop
			(assign, "$g_last_multiplayer_squad_size", -1), # constant size for coop
      (assign, "$g_round_ended", 0),
      (assign, "$g_total_players", 0), 
      (assign, "$g_total_team_1_players", 0), 
      (assign, "$g_total_team_1_players_last", 0), 
      ...
      (store_random_in_range, "$g_broadcast_development_info", 3600, 5400),
      (store_random_in_range, "$g_broadcast_map_name", 1800, 3600),
      ...
      (assign, "$g_enemy_allowed_alive_1", 90),
      (assign, "$g_enemy_allowed_alive_2", 80),
      ...
      (assign, "$g_gates_hit_timer", 3), #gate hit timer to decrease lag
  	  ...
  	  (assign, "$g_anti_cart_spam_count_max", 15), #anti cart spam variable 
      (assign, "$g_one_time_run", 0), #DEBUG
      ...
      (assign, "$g_cart_defenders_monitor_check", 5),
	  (assign, "$g_ally_cart_attackers_monitor_check", 5),
      (assign, "$g_ally_cart_attackers_monitor_check_hit", 2),
	  (assign, "$g_enemy_cart_defenders", 0),
	  (assign, "$g_enemy_ally_cart_attackers", 0),
      (assign, "$g_wave30_cool_down", 60),
      (assign, "$g_daimyo_debug_mode", 0), #Dy Debug Mode
      (assign, "$g_prison_cart_destroyed", 0), #Dy global variable to determine cart destroyed
      (assign, "$g_gren_rearm_interval", 20),   #Dy individual grenade rearm interval
      (assign, "$g_gren_rearm_interval_2", 30),   #Dy individual grenade rearm interval
      (assign, "$g_gren_rearm_interval_3", 35),   #Dy individual grenade rearm interval
      (assign, "$g_gren_rearm_interval_4", 40),   #dy individual grenade rearm interval
      (assign, "$g_multi_quiver_rearm", 20),   #dy individual grenade rearm interval      
      (assign, "$g_rearm_interval", 0),         #dy global variable to determine rearm interval
			(assign, "$g_check_underground", 0),         #dy global variable to check for bots underground
      #(store_random_in_range, "$g_enemy_melee_check", 60, 180), #dy global variable to do a random calculation of whether or not to arm enemy range with melee weapons
      #(assign, "$g_final_melee_check", 20),         #dy global variable this is just an interval to check during last waves
      (assign, "$g_cart_defenders_check", 10),    #dy normal check for cart defenders
	  (assign, "$g_ally_cart_attackers_check", 8),    #dy normal check for cart defenders
      (call_script, "script_multiplayer_ccoop_destroy_prison_cart"),  # destroy prison cart (since it is invisible when mission starts)
      (assign, "$g_global_enemy_count", 0),
      (assign, "$g_global_friendly_count", 0),
      (assign, "$g_global_alive_player_count", 0),
      (scene_prop_get_instance, "$g_prison_cart", "spr_prison_cart", 0),
      (scene_prop_get_instance, "$g_prison_cart_left_door", "spr_prison_cart_door_left", 0),
      (scene_prop_get_instance, "$g_prison_cart_right_door", "spr_prison_cart_door_right", 0),
      

      #Quest Specifics Run-Time ONCE
      (assign, "$g_dy_quest_assassinate_vip_enabeld", 1), #ALL MAPS WORK
      (assign, "$g_dy_quest_defend_vip_enabeld", 1), #ALL MAPS WORK
      (assign, "$g_dy_quest_escort_vip_enabled", 0), #These will change based on compatibility of map
      ...
      (try_begin),
        ...
        (assign, "$g_reinforcement_health_mod", 180),
      ...
      (else_try),
        ...
        (assign, "$g_reinforcement_health_mod", 230),
      ...
      (else_try),
        ...
        (assign, "$g_reinforcement_health_mod", 305),
        (assign, "$g_reinforcement_horse_health", 305),
        (assign, "$g_reinforcement_damage_mod", 150),
      ...
      (assign, "$g_enemy_spawn_point_3", -1),
      ...
      (call_script, "script_daimyo_determine_quest_compatible_maps"), #Determine compatible maps
      #GEt props last
      (scene_prop_get_instance, "$g_dest_flag", "spr_ctf_flag_kingdom_2", 0),
      (scene_prop_get_instance, "$g_heros_flag", "spr_ctf_flag_kingdom_1", 0),
		...
		[
			...
			(store_trigger_param_1, ":exiting_player_no"),
			(call_script, "script_cf_multiplayer_event_team_change", ":exiting_player_no"),
      (player_set_slot, ":exiting_player_no", slot_player_current_intro_message, 0),
      (player_set_slot, ":exiting_player_no", slot_player_received_intro_messages, 0),
		]),
    ...
    # Trigger Param 2: horse agent id
     ...
     [
      ...
      (store_trigger_param_2, ":horse_agent_id"),
        (try_begin), ### ON PLAYER HORSE MOUNT
          (agent_is_active, ":agent_id"),
          (neg|agent_is_non_player, ":agent_id"),
          (agent_is_alive, ":agent_id"),
          (try_begin), #convert stray to player horse and update Time
             (agent_slot_eq, ":horse_agent_id", slot_agent_is_stray_horse, 1),
             (agent_set_slot, ":horse_agent_id", slot_agent_is_stray_horse, 0),
             (agent_set_slot, ":horse_agent_id", slot_agent_is_player_horse, 1),
             (store_mission_timer_a, ":cur_time"),
             (agent_set_slot, ":horse_agent_id", slot_agent_player_horse_timer, ":cur_time"), #set time
              #(display_message, "@AGENT_MOUNT_1"),
          (else_try), #Update Player Horse Time
             (agent_slot_eq, ":horse_agent_id", slot_agent_is_player_horse, 1),
             (store_mission_timer_a, ":cur_time"),
             (agent_set_slot, ":horse_agent_id", slot_agent_player_horse_timer, ":cur_time"), #set time
           # (display_message, "@AGENT_MOUNT_2"),
          (try_end),
        (else_try), ### ON OTHER AGENT HORSE MOUNT
          (agent_is_active, ":agent_id"),
          (agent_is_non_player, ":agent_id"),
          (agent_is_alive, ":agent_id"),
          (try_begin), #convert player horse to stray horse
             (agent_slot_eq, ":horse_agent_id", slot_agent_is_player_horse, 1),
             (agent_set_slot, ":horse_agent_id", slot_agent_is_player_horse, 0),
             (agent_set_slot, ":horse_agent_id", slot_agent_is_stray_horse, 1),
             (store_mission_timer_a, ":cur_time"),
             (agent_set_slot, ":horse_agent_id", slot_agent_stray_horse_timer, ":cur_time"), #set time
            #(display_message, "@AGENT_MOUNT_3"),
          (else_try), #Update Agent Horse Time
             (agent_slot_eq, ":horse_agent_id", slot_agent_is_stray_horse, 1),
             (store_mission_timer_a, ":cur_time"),
             (agent_set_slot, ":horse_agent_id", slot_agent_stray_horse_timer, ":cur_time"), #set time
            #(display_message, "@AGENT_MOUNT_4"),
          (try_end),
        (try_end),
      #(display_message, "@AGENT MOUNTED"),
     ]),
    ...
    # Trigger Param 2: horse agent id
	 ...
	 [
		(store_trigger_param_1, ":agent_id"),
    (store_trigger_param_2, ":horse_agent_id"),
      (try_begin), ### ON PLAYER HORSE DISMOUNT ###
          (agent_is_active, ":agent_id"),
          (neg|agent_is_non_player, ":agent_id"),
          (agent_is_alive, ":agent_id"),
          (try_begin), #Set first time Player Horses
             (agent_slot_eq, ":horse_agent_id", slot_agent_is_player_horse, 0),
             (agent_set_slot, ":horse_agent_id", slot_agent_is_player_horse, 1),
             (store_mission_timer_a, ":cur_time"),
             (agent_set_slot, ":horse_agent_id", slot_agent_player_horse_timer, ":cur_time"), #set time
            #(display_message, "@AGENT_DISMOUNT_1"),
          (else_try), #Update Player Horse Time
             (agent_slot_eq, ":horse_agent_id", slot_agent_is_player_horse, 1),
             (store_mission_timer_a, ":cur_time"),
             (agent_set_slot, ":horse_agent_id", slot_agent_player_horse_timer, ":cur_time"), #set time
            #(display_message, "@AGENT_DISMOUNT_2"),
          (try_end),
        (else_try), ### ON NON PLAYER AGENT HORSE DISMOUNT ###
          (agent_is_active, ":agent_id"),
          (agent_is_non_player, ":agent_id"),
          (agent_is_alive, ":agent_id"),
          (try_begin),#Update Agent Horse Time
             (agent_slot_eq, ":horse_agent_id", slot_agent_is_stray_horse, 1),
             (store_mission_timer_a, ":cur_time"),
             (agent_set_slot, ":horse_agent_id", slot_agent_stray_horse_timer, ":cur_time"), #set time
            #(display_message, "@AGENT_DISMOUNT_3"),
          (try_end),
        (try_end),
		#(call_script, "script_game_event_agent_dismounted", ":cur_agent"),
    #(display_message, "@AGENT DISMOUNTED!!!!!!!!!!"),
	 ]),
    ...
    #                      rotation gives the direction of the blow
     ...
     [
        ...
        (store_trigger_param_2, ":hitter"),
        (store_trigger_param_3, ":damage"),
        #(display_message, "@HIT HIT HIT"),
        (try_begin),
          (agent_slot_eq, ":victim", slot_agent_is_cart_defender, 1),
          (agent_is_active, ":victim"),
          (agent_is_non_player, ":victim"),
          (agent_is_alive, ":victim"),
          (agent_is_human, ":victim"),
          (agent_get_team, ":dy_agent_team", ":victim"),
          (eq, ":dy_agent_team", 1),
          (agent_get_position, pos19,":victim"),
          (store_random_in_range, ":chosen_door", 0, 100),
          (try_begin),
            (lt, ":chosen_door", 50),
            (prop_instance_get_position, pos18, "$g_prison_cart_left_door"),
          (else_try),
            (prop_instance_get_position, pos18, "$g_prison_cart_right_door"),
          (try_end),
          (get_sq_distance_between_positions, ":distance", pos18,pos19), #4m * 4m * 100 = 1600, 10m * 10m * 100 = 10000
          (le, ":distance", 10000),
          (agent_slot_eq, ":victim", slot_agent_is_in_scripted_mode, 1),
          (agent_clear_scripted_mode, ":victim"),
          (agent_is_active, ":hitter"),
          (agent_set_look_target_agent, ":victim", ":hitter"),
          (agent_force_rethink, ":victim"),
          (agent_set_slot, ":victim", slot_agent_is_in_scripted_mode, 0),                
        (try_end),
		
		 (try_begin),
          (agent_slot_eq, ":victim", slot_agent_is_ally_cart_attacker_agent, 1),
          (agent_is_active, ":victim"),
          (agent_is_non_player, ":victim"),
          (agent_is_alive, ":victim"),
          (agent_is_human, ":victim"),
		...
		(ti_on_agent_killed_or_wounded, 0, 0, [],
		[
      #When a Cart guard is attacked (THATS NEAR CART), clear scripted, force re-think, set new target
			(store_trigger_param_1, ":dead_agent_no"), 
			(store_trigger_param_2, ":killer_agent_no"), 
			(call_script, "script_multiplayer_server_on_agent_killed_or_wounded_common", ":dead_agent_no", ":killer_agent_no"),
			...
			(try_end),
			 ...
			 #Daimyo Quest Dead Friendly START
        (try_begin),
            (multiplayer_is_server),
            (eq, ":dead_agent_no", "$g_agent_hero_global_id_1"),
            (try_begin),
              (this_or_next|eq, "$g_chosen_quest_type", 0), #Escort Friendly/Enemy
              (eq, "$g_chosen_quest_type", 1),
              (try_begin),
                (eq, ":dead_agent_team", 0),
            ...
            (else_try),
              (eq, "$g_chosen_quest_type", 3),#Defend Agent
              (eq, ":dead_agent_team", 0),
              (assign, "$g_dy_quest_complete", 2),
              (display_message, "@QUEST FAILED."),
        ...
        (try_end),
        #Daimyo Quest Dead Friendly END

        #Daimyo Track Guards START
        (try_begin),
          (multiplayer_is_server),
          (agent_is_active, ":dead_agent_no"),
          (neg|agent_is_alive, ":dead_agent_no"),
          (agent_slot_eq, ":dead_agent_no", slot_agent_is_hero_guard, 1),
          (val_sub, "$g_hero_guards_quest", 1), #Keep track of hero guards
          (agent_set_slot, ":dead_agent_no", slot_agent_is_hero_guard, 0),
        (try_end),
        #Daimyo Track Guards END

			# if dead agent is in wave team
			(try_begin),
				(multiplayer_is_server),				
				(eq, ":dead_agent_team", 1),  # enemy (wave) side
        (val_sub, "$g_global_enemy_count", 1),   # Daimyo Global Enemy Count
        (try_begin),
          (agent_is_active, ":dead_agent_no"),
          (agent_slot_eq, ":dead_agent_no", slot_agent_is_cart_defender, 1),
          (agent_set_slot, ":dead_agent_no", slot_agent_is_cart_defender, 0),
  				(val_sub, "$g_enemy_cart_defenders", 1),
        (try_end),
        (try_begin),
          (agent_is_active, ":dead_agent_no"),
          (agent_slot_eq, ":dead_agent_no", slot_agent_is_vip_attacker, 1),
          (agent_set_slot, ":dead_agent_no", slot_agent_is_vip_attacker, 0),
          (val_sub, "$g_enemy_vip_attackers", 1),
        (try_end),
          ...
          (agent_is_active, ":cur_agent"),
			...
			(else_try),				
				...
				(try_begin),
					(neg|agent_is_non_player, ":dead_agent_no"),
					(val_sub, "$g_global_alive_player_count", 1),
				(try_end),
        	(val_sub, "$g_global_friendly_count", 1),   # Daimyo Global Enemy Count
      (try_begin),
        (agent_slot_eq, ":dead_agent_no", slot_agent_is_ally_cart_attacker_agent, 1),
        (agent_set_slot, ":dead_agent_no", slot_agent_is_ally_cart_attacker_agent, 0),
        (val_sub, "$g_enemy_ally_cart_attackers", 1),
      (try_end),
				#(display_message, "@{!}dead agent is on our team!"),
      ...
      (try_begin),
        (eq, ":dead_agent_no", "$g_agent_hero_global_id_1"),
        (assign, "$g_agent_hero_global_id_1", -1),
      (try_end),
		]),
    ...
    (3, 0, 0, [(multiplayer_is_server),#Enable/Disable Horses?
      (eq, "$g_map_horses_enabled", 0), 
              ],
    [
      (try_begin),
        (eq, "$g_map_horses_enabled", 0),
    ...
    [
      (try_begin), #Total players in console, Also do Ping Check
        (assign, ":total_players", 0),
        (assign, ":total_players_team_1", 0),
        (get_max_players, ":num_players"),  #Broadcast to all players  
        (try_for_range, ":player_no", 1, ":num_players"), #0 is server so starting from 1
          (player_is_active, ":player_no"),
          (try_begin), #Reset player_squad_adjusted slot
            (gt, "$g_multiplayer_ccoop_enemy_respawn_secs", 30),
            (player_slot_eq, ":player_no", slot_player_squad_adjusted, 1),
            (player_set_slot, ":player_no", slot_player_squad_adjusted, 0),
          (try_end),
          #(call_script, "script_dy_regulate_high_ping_players", ":player_no"), #REGULATE HIGH PING PLAYERS
          (try_begin),
            (gt, "$g_multiplayer_ccoop_game_started", 0),
            (lt, "$g_multiplayer_ccoop_enemy_respawn_secs", 31),
            (call_script, "script_dy_broadcast_squad_size_specifics", ":player_no"),
          (try_end),
          (val_add, ":total_players", 1),
          (player_get_team_no, ":player_team_no",":player_no"),
          (eq, ":player_team_no", 0),
          (val_add, ":total_players_team_1", 1),
        (try_end),
        (assign, "$g_total_players", ":total_players"),
        (assign, "$g_total_team_1_players", ":total_players_team_1"),
      ...
      (try_begin), #Enable or Disable Dynamic Squad Sizes
        ...
        (neq, "$g_total_team_1_players_last", "$g_total_team_1_players"),
        (assign, "$g_total_team_1_players_last", "$g_total_team_1_players"), 
        (call_script, "script_dy_calculate_dynamic_squad_size"),
      (else_try),
        (this_or_next|lt, "$g_total_team_1_players", "$g_min_plyr_enable_dyn_sqds"), #Debug
        (le, "$g_multiplayer_ccoop_wave_no", 4),
        #or (le, "$g_multiplayer_ccoop_wave_no", 1),
        (assign, "$g_multiplayer_squad_size", 16), # constant size for coop
      ...
      (try_begin), #Adjust player squads
         (lt, "$g_multiplayer_ccoop_enemy_respawn_secs", 31),
         #(neq, "$g_last_multiplayer_squad_size", "$g_multiplayer_squad_size"),
         (get_max_players, ":num_players"),  #Broadcast to all players  
         (try_for_range, ":player_no", 1, ":num_players"), #0 is server so starting from 1
            ...
            (player_get_team_no, ":player_team_no",":player_no"),
            (eq, ":player_team_no", 0),
            (player_slot_eq, ":player_no", slot_player_squad_adjusted, 0),
            (call_script, "script_dy_adjust_player_squads_sizes", ":player_no"), #Adjust size of squads
            (player_set_slot, ":player_no", slot_player_squad_adjusted, 1),
         (try_end),
      (try_end),
      ...
      (else_try),
        (gt, "$g_multiplayer_ccoop_wave_no", 4),
        (eq, "$g_bonus_squad_money_given", 0),
        (ge, "$g_total_team_1_players", "$g_min_plyr_enable_dyn_sqds"),
        (get_max_players, ":num_players"),  #Broadcast to all players  
        (try_for_range, ":player_no", 1, ":num_players"), #0 is server so starting from 1
            (player_is_active, ":player_no"),
            ...
            (player_get_gold, ":dy_current_gold", ":player_no"),
            (store_mul, ":dy_bonus_gold", ":dy_bonus_gold", "$g_multiplayer_squad_size"),
            (val_add, ":dy_current_gold", ":dy_bonus_gold"),
            (player_set_gold, ":player_no", ":dy_current_gold"),
            (assign, reg0, ":dy_bonus_gold"),
            (str_store_string, s10, "str_you_received_bonus_gold_reg0_for_dynamic_squad"),
            ...
            (try_begin),#Play gold sound
              (agent_is_alive, ":player_agent_id"), #play sound
              (agent_get_position, pos16, ":player_agent_id"),
              (copy_position,pos60,pos16),
              (call_script,"script_multiplayer_server_play_sound_at_position","snd_money_received"),
            (try_end),
         (try_end), #try for range players END
         (assign, "$g_bonus_squad_money_given", 1),
      (try_end),
      ...
      #  (call_script, "script_dy_balance_round_agents_numbers"),
      #(try_end),
      
      #(try_begin),
      #  (lt, "$g_multiplayer_ccoop_enemy_respawn_secs", 3),
      #  (assign, ":division_rand", 5),
      #  (get_max_players, ":num_players"),  #Broadcast to all players  
      #  (try_for_range, ":player_no", 1, ":num_players"), #0 is server so starting from 1
      #    (player_is_active, ":player_no"),
      #    (player_get_team_no, ":player_team",":player_no"),
      ...
      #        (eq, ":agent_team", ":player_team"), 
              #DO things to squad directly
      #      (try_end), 
      #    (try_end), #try for agents END
      #  (try_end),#try for range players END
      #(try_end),
      (assign, "$g_last_multiplayer_squad_size", "$g_multiplayer_squad_size"), # Remember last squad size
		...
		[
          ...
          (try_begin), #Vet Elite Wave MOD
             (eq, "$g_multiplayer_ccoop_wave_no", 20),
             (assign, "$g_multiplayer_ccoop_wave_no", 28),
          (else_try),
             (eq, "$g_multiplayer_ccoop_wave_no", 10),
             (assign, "$g_multiplayer_ccoop_wave_no", 18),
          (else_try),
          ...
          (try_begin),
            ...
            (store_sub, ":free_enemy_slots", "$g_enemy_allowed_alive_init_1", reg0), #enemy required 
            (assign, ":reinforce_percentage", "$g_enemy_allowed_reinforce_init_1"), 
          (else_try),
            (eq, "$g_dy_reduce_enemy_spawn", 1),
            (store_sub, ":free_enemy_slots", "$g_enemy_allowed_alive_init_2", reg0), #enemy required 
            (assign, ":reinforce_percentage", "$g_enemy_allowed_reinforce_init_2"),
          (else_try),
          	(eq, "$g_dy_reduce_enemy_spawn", 2),
            (store_sub, ":free_enemy_slots", "$g_enemy_allowed_alive_init_3", reg0), #enemy required 
          ...
          #Daimyo Quest AGENT SPAWN END
					# spawn wave #Normal Method
    ...
    (0.1, 0, 0, [(multiplayer_is_server),
                  (eq, "$g_dy_quest_in_progress", 1),
                  (eq, "$g_vip_agent_spawned", 1)],   #Daimyo QUEST Fast Tick
    [
        (try_begin),
          (le, "$g_dy_quest_start_countdown", 0),
          (neq, "$g_dy_quest_complete", 1),
          (agent_is_alive, "$g_agent_hero_global_id_1"),
          (agent_get_position, pos60, "$g_agent_hero_global_id_1"),
          (position_get_z, ":vip_height_z", pos60),
          #(position_get_distance_to_terrain, ":terrain_mod", pos60),
          #(position_get_distance_to_ground_level, ":terrain_mod2", pos60),
          #(assign, "$g_terrain_mod", ":terrain_mod"),
          (assign, ":flag_height", 600),
          #(val_add, ":flag_height", ":terrain_mod"),
          #(val_add, ":flag_height", ":terrain_mod2"),
          (val_add, ":flag_height", ":vip_height_z"),
          (position_set_z, pos60, ":flag_height"),
          #(scene_prop_get_instance, "$g_heros_flag", "spr_ctf_flag_kingdom_1", 0),
          (prop_instance_set_position, "$g_heros_flag", pos60),
          #(prop_instance_get_position, pos60, "$g_heros_flag"),
          #(position_set_z, pos60, ":flag_height"),
          #(prop_instance_set_position, "$g_heros_flag", pos60),
        (try_end),
        ...
        (try_begin),
          ...
          #(eq, ":block_this_from_executing", -999999), #Keep track of hero guards
          (gt, "$g_hero_guards_quest", -1), #Keep track of hero guards
          (agent_get_position, pos55, "$g_agent_hero_global_id_1"),
          (assign, ":guards_nearby", 0),
          (try_for_range, ":cur_hero", 0, "$g_hero_guard_total"), ### MOD GUARD NUM
            #(agent_get_position, pos24, "$g_agent_hero_global_id_1"),
            ...
            (try_begin),
              (agent_get_team, ":guard_agent_team", ":hero_guard_agent"),
              #(eq, ":guard_agent_team", 1),
              (agent_get_position, pos40, ":hero_guard_agent"),
              (get_sq_distance_between_positions, ":dist_vip_from_guard", pos40, pos55),
              (try_begin),
                (le, ":dist_vip_from_guard", 6400),
                (val_add, ":guards_nearby", 1),
              (try_end),
              #(get_max_players, ":num_players"),
              (try_begin), #Keep the party moving if enemies dead
                (eq, ":guard_agent_team", 0),
                (eq, "$g_global_enemy_count", 0),
                (call_script, "script_dy_set_vip_guardpos", ":hero_guard_agent"),
                (agent_set_scripted_destination, ":hero_guard_agent", pos8),
              ...
              (else_try),
                (try_for_agents, ":cur_agent"),
                  ...
                  (agent_is_human, ":cur_agent"),
                  (agent_get_team, ":agent_team", ":cur_agent"),
                  (neq, ":guard_agent_team", ":agent_team"),
                  (agent_get_position, pos41, ":cur_agent"),
                  (get_sq_distance_between_positions, ":distance_from_enemy", pos40, pos41),
                  (get_sq_distance_between_positions, ":distance_from_vip", pos41, pos55),
                  (get_sq_distance_between_positions, ":distance_enemy_from_vip", pos41, pos55),
                  #Lets get enemies nearby
                  (try_begin),
                      (le, ":distance_from_enemy", 14400),
                      (try_begin),
                        (gt, ":distance_from_vip", 10000),
                        (call_script, "script_dy_set_vip_guardpos", ":hero_guard_agent"),
                        (agent_set_scripted_destination, ":hero_guard_agent", pos8),
                      (else_try),
                        (le, ":distance_enemy_from_vip", 6400),
                        (agent_clear_scripted_mode, ":hero_guard_agent"),
                        (agent_set_look_target_agent, ":hero_guard_agent", ":cur_agent"),
                        (agent_set_look_target_agent, "$g_agent_hero_global_id_1", ":cur_agent"),
                        (agent_force_rethink, "$g_agent_hero_global_id_1"),
                        (agent_force_rethink, ":hero_guard_agent"),
                      (else_try),
                        (le, ":distance_from_enemy", 10000),
                        (agent_clear_scripted_mode, ":hero_guard_agent"),
                        (agent_set_look_target_agent, ":hero_guard_agent", ":cur_agent"),
                        (agent_force_rethink, ":hero_guard_agent"),
                      (try_end),
              ...
              (try_end),
            (try_end),
          (try_end), #Try for range guard hero END
            (try_begin),
              (this_or_next|eq, "$g_chosen_quest_type", 0),
              (eq, "$g_chosen_quest_type", 1),
              (try_begin),
                (store_div, ":half_the_guards", "$g_hero_guards_quest", 2),
                (lt, ":guards_nearby", ":half_the_guards"),
                (gt, "$g_hero_guards_quest", 4),
                (agent_get_horse, ":vip_horse", "$g_agent_hero_global_id_1"),
                (eq, ":vip_horse", -1),
                (agent_get_position, pos61, "$g_agent_hero_global_id_1"),
                (agent_set_scripted_destination, "$g_agent_hero_global_id_1", pos61),
              (else_try),
                (eq, "$g_guard_hero_wait_interval", 0),
                (entry_point_get_position, pos23, "$g_vip_hero_destination_point"),
                (agent_set_scripted_destination, "$g_agent_hero_global_id_1", pos23),
              (try_end),
            (try_end),
		...
		(1, 0, 0, [(multiplayer_is_server), 
              (eq, "$g_dy_quest_in_progress", 1)],   #Daimyo QUEST MONITOR TICK
    [
        (neq, "$g_dy_quest_complete", 1),
        (eq, "$g_dy_quest_in_progress", 1),
        (try_begin),
          (ge, "$g_dy_quest_start_countdown", 0),
          (val_sub, "$g_dy_quest_start_countdown", 1), 
        (try_end),
        (try_begin),
          (gt, "$g_quest_expire_countdown", 0),
          (val_sub, "$g_quest_expire_countdown", 1),
        (try_end),
        (try_begin),
          (eq, "$g_dy_quest_start_countdown", 0),
          (neq, "$g_vip_agent_spawned", 1),
            (try_begin),
              (eq, "$g_chosen_quest_type", 0), #Friendly Escort
              (call_script, "script_dy_quest_spawn_agents", 0), # 0 = Team Parameter
            (else_try),
               (eq, "$g_chosen_quest_type", 1), #Enemy Escort
               (call_script, "script_dy_quest_spawn_agents", 1), # 1 = Team Parameter
            (else_try),
               (eq, "$g_chosen_quest_type", 2), #Enemy Assassinate
               (call_script, "script_dy_quest_spawn_agents", 1), # 1 = Team Parameter
            (else_try),
        ...
        (try_end),
        (try_begin),
            (lt, "$g_dy_quest_start_countdown", 0), 
            (eq, "$g_vip_agent_spawned", 1),
            (agent_is_alive, "$g_agent_hero_global_id_1"), #on_agent_killed handles deaths
            (try_begin), #IF Quest 0 and 3 (friendly Escort + Defend)
                (this_or_next|eq, "$g_chosen_quest_type", 0),
                (eq, "$g_chosen_quest_type", 3),
                (call_script, "script_daimyo_monitor_quest", 0), #Param 0 = team
            (else_try),  #IF Quest 1 and 2 (Enemy Escort + Assassinate)
                (this_or_next|eq, "$g_chosen_quest_type", 1),
                (eq, "$g_chosen_quest_type", 2),
                (call_script, "script_daimyo_monitor_quest", 1), #Param 1 = team
            (try_end),
        (try_end),
        (try_begin), #Hero wait interval check (when infantry, and guards are far behind)
          (val_sub, "$g_guard_hero_wait_interval", 1),
          (lt, "$g_guard_hero_wait_interval", 0),
          (store_random_in_range, "$g_guard_hero_wait_interval", 5, 8),
        (try_end),

        #VIP Attacker Monitor START
        (try_begin),
            (try_begin),
            #(eq, "$g_guard_hero_wait_interval", 1),
              (eq, "$g_vip_agent_spawned", 1),
              (assign, ":attackers_left", 0),
              (try_for_agents, ":cur_agent"),
                (try_begin),
                  (lt, ":attackers_left", "$g_enemy_vip_attackers"), #break
                  (agent_slot_eq, ":cur_agent", slot_agent_is_vip_attacker, 1),
                  (agent_is_active, ":cur_agent"),
                  (agent_is_alive, ":cur_agent"),
                  (agent_is_human, ":cur_agent"),
                  (val_add, ":attackers_left", 1),
                  (agent_get_position, pos36, "$g_agent_hero_global_id_1"),
                  (agent_get_position, pos37, ":cur_agent"),
                  (get_sq_distance_between_positions, ":distance", pos36, pos37),
                  (le, ":distance", 10000),
                  (agent_clear_scripted_mode, ":cur_agent"),
                  (agent_set_look_target_agent, ":cur_agent", "$g_agent_hero_global_id_1"),
                  (agent_force_rethink, ":cur_agent"),
                (try_end),
              (ge, ":attackers_left", "$g_enemy_vip_attackers"), #break
              (try_end), #Try end agents END
            (try_end),
        (try_end),
        #Vip Attacker Monitor END

       (call_script, "script_daimyo_broadcast_quest_info"), #Broadcast Quest Info


    ]), 
    
    (1, 0, 0, [(multiplayer_is_server), 
              (eq, "$g_dy_quest_in_progress", -1), (eq, "$g_enable_quest", 1)],   #Daimyo Quest MAIN TICK LOOP
    [

       (gt, "$g_multiplayer_ccoop_game_started", 0), #Global Has game even started?
       (assign, reg33, "$g_quest_main_countdown"),
       (display_message, "@Quest Main Countdown: {reg33}"),
       (try_begin),
         (eq, "$g_dy_quest_in_progress", -1),
         (gt, "$g_quest_main_countdown", 0),  
         (val_sub, "$g_quest_main_countdown", 1),     
       (try_end),

        (try_begin),
          (lt, "$g_quest_main_countdown", 1),
          (eq, "$g_dy_quest_in_progress", -1),  
          (call_script, "script_select_random_quest_and_setup"),
          (assign, "$g_dy_quest_in_progress", 1),
        (try_end),

      #(try_end), #DAIMYO QUEST SYSTEM ##### END #####
    ]),   		
    
    #DY Server Intro message tick
    #This broadcast intro server and other recurring messages
    (1, 0, 0, [(multiplayer_is_server),(eq, "$g_start_server_message_tick", 1)], 
    [
        ...
        (try_begin),
          ...
          (try_for_range, ":player_no", 1, ":num_players"),
            ...
            (try_begin), #SERVER BROADCAST INTRO
              (lt, ":player_cur_message", "$g_max_server_intro_messages"),
              (call_script, "script_dy_broadcast_server_intro_message", ":player_no", ":player_cur_message"),
            (else_try),
              (ge, ":player_cur_message", "$g_max_server_intro_messages"),
    ...
    #DY Main Loop Start
      ...
      (try_begin),
        ...
        # (this_or_next|eq, "$g_multiplayer_ccoop_wave_no", 19),
        # (this_or_next|eq, "$g_multiplayer_ccoop_wave_no", 20),
        # (this_or_next|eq, "$g_multiplayer_ccoop_wave_no", 29),
        # (this_or_next|eq, "$g_multiplayer_ccoop_wave_no", 30),
        # (le, "$g_multiplayer_ccoop_enemy_respawn_secs", 480),
        # (eq, "$g_multiplayer_ccoop_wave_no", 30), # == wave 30
        # (gt, "$g_multiplayer_ccoop_enemy_respawn_secs", 300),
        (try_begin),
           (eq, "$g_dy_reduce_enemy_spawn", 0),
           (assign, "$g_enemy_allowed_alive_1", 96),
           (store_div, "$g_enemy_allowed_reinforce_1", "$g_enemy_allowed_alive_1", 2),
        (else_try),
           (eq, "$g_dy_reduce_enemy_spawn", 1),
           (assign, "$g_enemy_allowed_alive_2", 86),
           (store_div, "$g_enemy_allowed_reinforce_2", "$g_enemy_allowed_alive_2", 2),
        (else_try),
           (eq, "$g_dy_reduce_enemy_spawn", 2),
           (assign, "$g_enemy_allowed_alive_3", 76),
           (store_div, "$g_enemy_allowed_reinforce_3", "$g_enemy_allowed_alive_3", 2),
        (try_end),
     (else_try),
        (neq, "$g_map_total_war", 1),
        ...
        (store_div, "$g_enemy_allowed_reinforce_3", "$g_enemy_allowed_alive_3", 2),
     (try_end),
      #(call_script, "script_dy_regulate_cart_hitters"), #DY Regulate cart hitters
      (call_script, "script_dy_cleanup_abandoned_squads"), #Cleanup abandoned squads

      (try_begin),  #Broadcast current map and mod map name
         (val_sub, "$g_broadcast_map_name", 1),
         (le, "$g_broadcast_map_name", 0),
        (get_max_players, ":num_players"),
         (try_for_range, ":player_no", 1, ":num_players"), #0 is server so starting from 1
            (player_is_active, ":player_no"),
            (call_script, "script_daimyo_get_names_of_maps"),
            (str_store_string, s10, "str_server_current_map_is_s0_mod_name_s1"),
            (multiplayer_send_string_to_player, ":player_no", multiplayer_event_show_server_message, s10),
         (try_end),
         (store_random_in_range, "$g_broadcast_map_name", 1800, 3600),
      (try_end),
      ...
      (try_begin),  #Broadcast current map and mod map name
         (val_sub, "$g_broadcast_development_info", 1),
         (le, "$g_broadcast_development_info", 0),
        (get_max_players, ":num_players"),
         (try_for_range, ":player_no", 1, ":num_players"), #0 is server so starting from 1
            (player_is_active, ":player_no"),
            (store_random_in_range, ":rand_num", 0, 2),
            (try_begin),
              (eq, ":rand_num", 0),
              (str_store_string, s10, "str_follow_development"),
            (else_try),
              (eq, ":rand_num", 1),
              (str_store_string, s10, "str_suggest_feedback_development"),
            (try_end),
            (multiplayer_send_string_to_player, ":player_no", multiplayer_event_show_server_message, s10),
         (try_end),
         (store_random_in_range, "$g_broadcast_development_info", 3600, 5400),
      ...
      (try_begin),
        ...
        #(lt, "$g_multiplayer_ccoop_enemy_respawn_secs", 20),
        #(call_script, "script_dy_test_agents"),
        (assign, "$g_one_time_run", 1),
      (try_end),

      (try_begin), #Cheer for 5 seconds after win
        (gt, "$g_multiplayer_ccoop_enemy_respawn_secs", 26),
        (set_cheer_at_no_enemy, 1),
      (else_try),
        (set_cheer_at_no_enemy, 0),
      (try_end),

      (call_script, "script_dy_dedicated_console_debug"), 

      #Monitor ALL Horses START
      (try_begin),
        (val_sub, "$g_horse_check", 1),
        (le, "$g_horse_check", 0),
        (call_script, "script_manage_monitor_horses"),
        (assign, "$g_horse_check", 12),
      (try_end),
      #Monitor ALL Horses END
      
      #Enemy Hit Gate Start
      # (try_begin),
      #    (val_sub, "$g_gates_hit_timer", 1),
      #    (le, "$g_gates_hit_timer", 0),
      #    (store_random_in_range,":attack_type",0,4), #0 = thrust, 1 = slashright, 2 = slashleft, 3 = overswing. Action value: 0 = ready and release, 1 = ready and hold.
      #   (try_for_agents, ":cur_agent"),
      #     (try_begin),
      #       (agent_is_active, ":cur_agent"),
      #       (agent_is_non_player, ":cur_agent"),
      ...
      #       (agent_get_position, pos29, ":cur_agent"),
      #       (scene_prop_get_num_instances, ":wall_instances", "spr_portcullis"),
      #       (assign, ":wall_type", "spr_portcullis"),
      #       (call_script, "script_check_if_agent_near_prop", pos29, ":wall_instances", ":wall_type"),
      #       (assign, ":prop_pos", reg49),
      #       (assign, ":dist_between", reg50),
      #       #(val_add, ":allowed_distance", ":dist_offset"),
      #       #(assign, ":allowed_distance", reg2),
      #       (le, ":dist_between", ":allowed_distance"),
      #       (agent_set_look_target_position, ":cur_agent", ":prop_pos"),
      #       (agent_set_attack_action, ":cur_agent", ":attack_type", 0),
      #       (agent_set_look_target_position, ":cur_agent", ":prop_pos"),
      #     (try_end),
      #   (try_end),
      #   (assign, "$g_gates_hit_timer", 3),
      # (try_end),
      #Enemy Hit Gate End


      #Defend VIP Enemy Attack START
      (try_begin),
        (val_sub, "$g_enemy_vip_attackers_check", 1),
        (le, "$g_enemy_vip_attackers_check", 0),
        (eq, "$g_dy_quest_in_progress", 1),
        (eq, "$g_chosen_quest_type", 3), #Defend quest chosen
        (gt, "$g_global_enemy_count", 0),
        (agent_is_active, "$g_agent_hero_global_id_1"),
        (agent_is_alive, "$g_agent_hero_global_id_1"),
        (lt, "$g_enemy_vip_attackers", 10),
        (store_random_in_range, "$g_enemy_vip_attackers_check", 30, 120), #interval to reinforce cart        
        (store_sub, ":attackers_remaining", "$g_max_vip_attackers", "$g_enemy_vip_attackers"),
        (gt, ":attackers_remaining", 0),
        (try_for_agents, ":cur_agent"), #Lets set guard positions to cart
          (try_begin),
            (gt, ":attackers_remaining", 0), #Break
            (agent_is_active, ":cur_agent"),
            (neq, ":cur_agent", "$g_agent_hero_global_id_1"),
            (neg|agent_slot_eq, ":cur_agent", slot_agent_is_hero_guard, 1),
            (neg|agent_slot_eq, ":cur_agent", slot_agent_is_cart_defender, 1),
            (agent_is_non_player, ":cur_agent"),
            ...
            (agent_is_human, ":cur_agent"),
              (try_begin),
                (agent_slot_eq, ":cur_agent", slot_agent_is_vip_attacker, 0),
                (agent_get_position, pos36, "$g_agent_hero_global_id_1"),
                (agent_clear_scripted_mode, ":cur_agent"),
                (agent_set_scripted_destination, ":cur_agent", pos36, 0),
                (agent_force_rethink, ":cur_agent"),
                (agent_set_slot, ":cur_agent", slot_agent_is_vip_attacker, 1),
                (val_add, "$g_enemy_vip_attackers", 1),
                (val_sub, ":attackers_remaining", 1),
              (try_end), #End 5 guys left check
          (try_end), 
          (gt, ":attackers_remaining", 0), #Break
        (try_end), #try for agents END
        
      (try_end),#Defend VIP Enemy Attack END

       (try_begin), #Daimyo Ally Cart Attackers START
       	(neq, "$g_prison_cart_destroyed", 1),
        (neq, "$g_prison_cart_point", 0), # if visible
       	(val_sub, "$g_ally_cart_attackers_check", 1),
        (le, "$g_ally_cart_attackers_check", 0),
		...
		#(gt, "$g_global_friendly_count", 10),
        (lt, "$g_enemy_ally_cart_attackers", 25),
        (call_script, "script_set_ally_cart_attackers"), #Set cart defenders up
      (try_end), #Daimyo Ally Cart Attackers END

      (try_begin), #Clear Ally Cart Attackerswhen no cart or its destroyed START
        (eq, "$g_prison_cart_destroyed", 1),
        (gt, "$g_enemy_ally_cart_attackers", 0),
        (try_for_agents, ":cur_agent"),
          (gt, "$g_enemy_ally_cart_attackers", 0), #Break
          (agent_slot_eq, ":cur_agent", slot_agent_is_ally_cart_attacker_agent, 1),
          (agent_set_slot, ":cur_agent", slot_agent_is_ally_cart_attacker_agent, 0),
		      (agent_ai_set_always_attack_in_melee, ":cur_agent", 0),
          (agent_clear_scripted_mode, ":cur_agent"),
          (agent_force_rethink, ":cur_agent"),
          (val_sub, "$g_enemy_ally_cart_attackers", 1),
        (try_end), #try for agents end
      (try_end), #Clear Ally Cart Attackerswhen no cart or its destroyed END

	  #Daimyo Ally Cart Atackers MONITOR START
      (try_begin),
        (gt, "$g_enemy_ally_cart_attackers", 0),
        (neq, "$g_prison_cart_destroyed", 1),
        (neq, "$g_prison_cart_point", 0), # if visible
        (val_sub, "$g_ally_cart_attackers_monitor_check", 1),
        (le, "$g_ally_cart_attackers_monitor_check", 0),
        (assign, "$g_ally_cart_attackers_monitor_check", 5), #interval to monitor cart defenders
        (assign, ":defenders_assigned", 0),
        
        (try_for_agents, ":cur_agent"), #Lets set guard positions to cart
            (lt, ":defenders_assigned", "$g_enemy_ally_cart_attackers"), #Break
            (agent_is_active, ":cur_agent"),
            (agent_slot_eq, ":cur_agent", slot_agent_is_ally_cart_attacker_agent, 1),
            (agent_is_alive, ":cur_agent"),
            (agent_is_human, ":cur_agent"),
			(agent_get_team, ":dy_agent_team", ":cur_agent"),
            (eq, ":dy_agent_team", 0),
            (val_add, ":defenders_assigned", 1), #Track to break loop
            (neg|agent_slot_eq, ":cur_agent", slot_agent_is_hero_guard, 1),
            (neg|agent_slot_eq, ":cur_agent", slot_agent_is_vip_attacker, 1),
            (neq, ":cur_agent", "$g_agent_hero_global_id_1"),
            (agent_is_non_player, ":cur_agent"),
            (try_begin),
              (agent_slot_eq, ":cur_agent", slot_agent_is_in_scripted_mode, 1),
              (try_for_agents, ":agent_enemy"), #Proximity check for cart defenders
                (agent_is_active, ":agent_enemy"),
                (agent_is_alive, ":agent_enemy"),
                (agent_is_human, ":agent_enemy"),
                (agent_get_team, ":agent_enemy_team", ":agent_enemy"),
                (eq, ":agent_enemy_team", 1),
                (neg|agent_slot_eq, ":agent_enemy", slot_agent_is_hero_guard, 1),
                (neg|agent_slot_eq, ":agent_enemy", slot_agent_is_vip_attacker, 1),
                (neq, ":agent_enemy", "$g_agent_hero_global_id_1"),
                (agent_get_position, pos19,":cur_agent"),
                (agent_get_position, pos18,":agent_enemy"),
                (get_sq_distance_between_positions, ":distance", pos18,pos19), #4m * 4m * 100 = 1600, 10m * 10m * 100 = 10000
                (le, ":distance", 2500),
                (agent_clear_scripted_mode, ":cur_agent"),
                (agent_set_look_target_agent, ":cur_agent", ":agent_enemy"),
                (agent_force_rethink, ":cur_agent"),
                (agent_set_slot, ":cur_agent", slot_agent_is_in_scripted_mode, 0),    
              (try_end), #Try for agents end proximity check
            (else_try),
              (agent_get_position, pos19,":cur_agent"),
              (store_random_in_range, ":chosen_door", 0, 100),
              (try_begin),
              ...
              (try_end),
              (get_sq_distance_between_positions, ":distance", pos18,pos19), #4m * 4m * 100 = 1600, 10m * 10m * 100 = 10000
              (try_begin),#Is in scripted mode and <= 10 meters from cart?
                (agent_slot_eq, ":cur_agent", slot_agent_is_in_scripted_mode, 0),
                (gt, ":distance", 10000),
                (set_fixed_point_multiplier, 100),
                ...
                (position_transform_position_to_parent, pos4, pos18, pos6),
                (agent_set_scripted_destination, ":cur_agent", pos4, 0),
                (agent_force_rethink, ":cur_agent"),
          ...
          (try_end), #Try for agents end
        (try_end), 
        #Daimyo Ally Cart Atackers MONITOR END
		
		#Daimyo Ally Cart Attackers ATTACK CART START!
		(try_begin),
			(gt, "$g_enemy_ally_cart_attackers", 0),
			(neq, "$g_prison_cart_destroyed", 1),
			(neq, "$g_prison_cart_point", 0), # if visible
			(val_sub, "$g_ally_cart_attackers_monitor_check_hit", 1),
			(le, "$g_ally_cart_attackers_monitor_check_hit", 0),
			(assign, "$g_ally_cart_attackers_monitor_check_hit", 2), #interval to monitor cart defenders
			(try_for_agents, ":cur_agent"), #Lets make attack in range of cart #4m * 4m * 100 = 1600, 10m * 10m * 100 = 10000
				(agent_slot_eq, ":cur_agent", slot_agent_is_ally_cart_attacker_agent, 1),
				(agent_is_active, ":cur_agent"),
				(agent_is_alive, ":cur_agent"),
				(agent_is_human, ":cur_agent"),
				(agent_get_position, pos19,":cur_agent"),
				(prop_instance_get_position, pos18, "$g_prison_cart_left_door"),
				(prop_instance_get_position, pos17, "$g_prison_cart_right_door"),
				(get_sq_distance_between_positions, ":distance", pos17,pos19), #4m * 4m * 100 = 1600, 10m * 10m * 100 = 10000
				(get_sq_distance_between_positions, ":distance2", pos18,pos19), #4m * 4m * 100 = 1600, 10m * 10m * 100 = 10000
				(this_or_next|le, ":distance", 1600),
				(le, ":distance2", 1600),
        (try_begin),
          (agent_get_horse, ":cur_agent_horse", ":cur_agent"),
          (neq, ":cur_agent_horse", -1),
          (remove_agent, ":cur_agent_horse"),
        (try_end),
				(try_begin),
					(le, ":distance", 1600),
					(assign, ":prop_pos", pos17),
					(store_random_in_range,":attack_type",0,4),
					(agent_set_look_target_position, ":cur_agent", ":prop_pos"),
					(agent_set_attack_action, ":cur_agent", ":attack_type", 0),
					(agent_set_look_target_position, ":cur_agent", ":prop_pos"),
				(else_try),
					(le, ":distance2", 1600),
					(assign, ":prop_pos", pos18),
					(store_random_in_range,":attack_type",0,4),
					(agent_set_look_target_position, ":cur_agent", ":prop_pos"),
					(agent_set_attack_action, ":cur_agent", ":attack_type", 0),
					(agent_set_look_target_position, ":cur_agent", ":prop_pos"),
			...
			(try_end),
		(try_end),
		#Daimyo Ally Cart Attackers ATTACK CART END!
		
		
      (try_begin), #Daimyo Cart Defenders START
        (val_sub, "$g_cart_defenders_check", 1),
        (le, "$g_cart_defenders_check", 0),
        (this_or_next|gt, "$g_multiplayer_ccoop_enemy_respawn_secs", 31),
        (eq, "$g_multiplayer_ccoop_wave_no", 30), # == wave 30
        (neq, "$g_prison_cart_destroyed", 1),
        (neq, "$g_prison_cart_point", 0), # if visible
        #(call_script, "script_get_any_enemy_alive", 1), #Lets check if > 5 alive to even set guards.
        (gt, "$g_global_enemy_count", 10),
        (lt, "$g_enemy_cart_defenders", 5),
        (assign, "$g_cart_defenders_check", 10), #interval to reinforce cart
        (call_script, "script_set_cart_defenders"), #Set cart defenders up
      (try_end), #Daimyo Cart Defenders END

      (try_begin), #Clear cart defenders when no cart or its destroyed START
        (this_or_next|le, "$g_global_enemy_count", 10),
        (eq, "$g_prison_cart_destroyed", 1),
        (gt, "$g_enemy_cart_defenders", 0),
        (try_for_agents, ":cur_agent"),
          (gt, "$g_enemy_cart_defenders", 0), #Break
          (agent_slot_eq, ":cur_agent", slot_agent_is_cart_defender, 1),
          (agent_set_slot, ":cur_agent", slot_agent_is_cart_defender, 0),
          (agent_clear_scripted_mode, ":cur_agent"),
          (agent_force_rethink, ":cur_agent"),
          (val_sub, "$g_enemy_cart_defenders", 1),
        (try_end), #try for agents end
      (try_end), #Clear cart defenders when no cart or its destroyed END

      #Daimyo Cart Defenders MONITOR START
      (try_begin),
        (gt, "$g_enemy_cart_defenders", 0),
        (neq, "$g_prison_cart_destroyed", 1),
        (neq, "$g_prison_cart_point", 0), # if visible
        (val_sub, "$g_cart_defenders_monitor_check", 1),
        (le, "$g_cart_defenders_monitor_check", 0),
        (assign, "$g_cart_defenders_monitor_check", 5), #interval to monitor cart defenders
        (assign, ":defenders_assigned", 0),
        
        (try_for_agents, ":cur_agent"), #Lets set guard positions to cart
            (lt, ":defenders_assigned", "$g_enemy_cart_defenders"), #Break
            (agent_is_active, ":cur_agent"),
            (agent_slot_eq, ":cur_agent", slot_agent_is_cart_defender, 1),
            (agent_is_alive, ":cur_agent"),
            (agent_is_human, ":cur_agent"),
          ...
          (try_end), #Try for agents end
        (try_end), 
        #Daimyo Cart Defenders MONITOR END

        #Clear QUEST VIP ATTACKERS START
      (try_begin), 
        (eq, "$g_dy_quest_in_progress", -1),
        (try_for_agents, ":cur_agent"),
          (agent_slot_eq, ":cur_agent", slot_agent_is_vip_attacker, 1),
          (agent_set_slot, ":cur_agent", slot_agent_is_vip_attacker, 0),
          (agent_clear_scripted_mode, ":cur_agent"),
          (agent_force_rethink, ":cur_agent"),
        (try_end), #try for agents end
      (try_end),
      #Clear QUEST VIP ATTACKERS END

      #Daimyo Endless wave 30
      (try_begin),
         (eq, "$g_multiplayer_ccoop_wave_no", 30), # == wave 30
         (val_sub, "$g_wave30_cool_down", 1),
         (lt, "$g_wave30_cool_down", 0),
         (le, "$g_multiplayer_ccoop_enemy_respawn_secs", 60),
         #(call_script, "script_get_any_enemy_alive", 1),
         (gt, "$g_global_enemy_count", 0),
         (assign, "$g_multiplayer_ccoop_enemy_respawn_secs", 60),
      (try_end),

      

      #Daimyo Fade Bots below map boundaries START  ##MAKE SURE ITS NOT PERFORMANCE HIT!
      (try_begin),
        (val_sub, "$g_check_underground", 1),
        (le, "$g_check_underground", 0),
        (try_for_agents, ":cur_agent"),
          (agent_get_team, ":dy_agent_team", ":cur_agent"),
          (lt, ":dy_agent_team", 2),
          (agent_is_alive, ":cur_agent"),
          (agent_get_position, pos1, ":cur_agent"),
          (position_get_distance_to_terrain, ":dist_to_terrain", pos1),
          (lt, ":dist_to_terrain", -300), #If below -300 then obviously unit is far below
          (try_begin),
            (agent_is_non_player, ":cur_agent"),
          ...
          (try_end),
        (try_end), #try for agents end
        (assign, "$g_check_underground", 30),
      (try_end),
      #(position_get_distance_to_terrain, reg1, pos1),
      #Daimyo Fade Bots below map boundaries END


      
      #Daimyo Rearm/Heal at Trough/Beds/Ammo Box START
      #spr_oim_trench_box
      #spr_oim_trench_box_set #ammo box
      #spr_oim_trench_basket_c -> spr_oim_trench_box -> spr_oim_trench_box_b to #spr_oim_trench_sandbag
      #ctf_flag_kingdom_5
      #spr_portcullis -> spr_bed_a -> _f -> spr_towngate_door_left #beds
      #spr_farm_house_c -> spr_feeding_trough_a -> spr_fire_big #trough
      #spr_bucket_a -> spr_straw_a -> spr_straw_b -> spr_straw_c -> spr_cloth_a #straw
      #Heal Agents
      (try_begin),
        (try_for_range,":nearest_bed", "spr_portcullis","spr_towngate_door_left"),
          (this_or_next|eq,":nearest_bed","spr_bed_a"),
          (this_or_next|eq,":nearest_bed","spr_bed_b"),
          (this_or_next|eq,":nearest_bed","spr_bed_c"),
          (this_or_next|eq,":nearest_bed","spr_bed_d"),
          (this_or_next|eq,":nearest_bed","spr_bed_e"),
          (eq,":nearest_bed","spr_bed_f"),
          (scene_prop_get_num_instances, ":prop_instances", ":nearest_bed"),
          (try_for_range,":cur_instance",0,":prop_instances"),
              (set_fixed_point_multiplier, 100),
              (call_script, "script_get_scene_prop_instance", ":cur_instance", 2, ":nearest_bed"),
              (assign, ":bed_id", reg0),
              (prop_instance_get_position, pos2, ":bed_id"),
              (assign, ":friendly_total", 0),        
              (try_for_agents, ":cur_agent"),
                (try_begin),
                  (lt, ":friendly_total", "$g_global_friendly_count"),   #Break
                  (agent_is_active, ":cur_agent"),
                  (agent_get_team, ":dy_agent_team", ":cur_agent"),
                  (eq, ":dy_agent_team", 0),
                  
                  #(neg|agent_is_non_player, ":cur_agent"), #debugging
                  (agent_is_alive, ":cur_agent"),
                  (agent_is_human, ":cur_agent"),
                  (val_add, ":friendly_total", 1), 
                  (agent_get_position, pos1, ":cur_agent"),
                  (get_sq_distance_between_positions, reg0, pos1, pos2), #4m * 4m * 100 = 1600, 10m * 10m * 100 = 10000
                  (position_get_distance_to_terrain, reg1, pos1),
                  (position_get_distance_to_terrain, reg2, pos2),
                  (store_sub, reg3, reg2, reg1),
                    #(display_message, "@{!}dist to terrain BED_FINAL {reg3} ."),
                  #(try_end),
                  (le, reg0, 14400), #15m x 15m * 100 = 22500
                  (is_between, reg3, -250, 251),
                  (store_agent_hit_points, ":cur_agent_health", ":cur_agent", 1),
                  (agent_get_player_id,":player_no",":cur_agent"),
                  #(lt, ":cur_agent_health", 100),
                  (val_add, ":cur_agent_health", 8),
                  (agent_set_hit_points, ":cur_agent", ":cur_agent_health", 1),
                (try_end),
                (ge, ":friendly_total", "$g_global_friendly_count"),   #Break
              (try_end), #end try for agents
        (try_end),  #end try for range
      (try_end),
    (try_end),

    #Heal Agent Horses Trough
    (try_begin),
        (try_for_range,":nearest_horse_heal", "spr_farm_house_c","spr_fire_big"),
          (eq,":nearest_horse_heal","spr_feeding_trough_a"),
          (scene_prop_get_num_instances, ":prop_instances", ":nearest_horse_heal"),
          (try_for_range,":cur_instance",0,":prop_instances"),
              (set_fixed_point_multiplier, 100),
              (call_script, "script_get_scene_prop_instance", ":cur_instance", 3, ":nearest_horse_heal"),
              (assign, ":horse_heal_id", reg0),
              (prop_instance_get_position, pos2, ":horse_heal_id"),
              (assign, ":friendly_total", 0),      
              (try_for_agents, ":cur_agent"),
                (try_begin),
                  (lt, ":friendly_total", "$g_global_friendly_count"),   #Break
                  ...
                  (try_begin),
                    ...
                    (agent_is_alive, ":horse_agent"),
                    # refill horse health
                    (store_agent_hit_points, ":cur_horse_agent_health", ":horse_agent", 1),
                    #(lt, ":cur_horse_agent_health", 100),
                    (val_add, ":cur_horse_agent_health", 8),
                    (agent_set_hit_points, ":horse_agent", ":cur_horse_agent_health", 1),
                  (try_end),
                (try_end),
                (ge, ":friendly_total", "$g_global_friendly_count"), #break
              (try_end), #end try for agents
        (try_end),  #end try for range
      (try_end), #try for range 2
    (try_end),

    #Heal Agent Horses Straw
    (try_begin),
        (try_for_range,":nearest_horse_heal", "spr_bucket_a","spr_cloth_a"),
          (this_or_next|eq,":nearest_horse_heal","spr_straw_a"),
          (this_or_next|eq,":nearest_horse_heal","spr_straw_b"),
          (eq,":nearest_horse_heal","spr_straw_c"),
          (scene_prop_get_num_instances, ":prop_instances", ":nearest_horse_heal"),
          (try_for_range,":cur_instance",0,":prop_instances"),
              (set_fixed_point_multiplier, 100),
              (call_script, "script_get_scene_prop_instance", ":cur_instance", 3, ":nearest_horse_heal"),
              ...
              (try_for_agents, ":cur_agent"),
                (try_begin),
                  ...
                  (position_get_distance_to_terrain, reg2, pos2),
                  (store_sub, reg3, reg2, reg1),
                  (le, reg0, 6400), #15m x 15m * 100 = 22500
                  (is_between, reg3, -250, 251),
                  (try_begin),
                    # if agent has a horse
                    (agent_get_horse, ":horse_agent", ":cur_agent"), 
    ...
    (try_end),
      ...
      #Daimyo Rearm at Ammo Box START
      (try_begin),
        (val_sub, "$g_rearm_interval", 1),
        (val_sub, "$g_gren_rearm_interval", 1),
        (val_sub, "$g_gren_rearm_interval_2", 1),
        (val_sub, "$g_gren_rearm_interval_3", 1),
        (val_sub, "$g_gren_rearm_interval_4", 1),
        (val_sub, "$g_multi_quiver_rearm", 1),
        (try_for_range,":ammo_box", "spr_oim_broken_barrel","spr_oim_dead_tree"),
          #Ammo Refill
          (this_or_next|eq,":ammo_box","spr_oim_trench_box"),
          (eq,":ammo_box","spr_oim_trench_box_set"),
          (scene_prop_get_num_instances, ":prop_instances", ":ammo_box"),
          #(gt,":prop_instances",0), # do we even have this prop around? :o
            (try_for_range,":cur_instance",0,":prop_instances"),
              (set_fixed_point_multiplier, 100),
              (call_script, "script_get_scene_prop_instance", ":cur_instance", 1, ":ammo_box"),
              (assign, ":ammo_box_id", reg0),
              (prop_instance_get_position, pos2, ":ammo_box_id"),
              (assign, ":friendly_total", 0),   
              (try_for_agents, ":cur_agent"),
                (try_begin),
                  (lt, ":friendly_total", "$g_global_friendly_count"),   #Break
                  ...
                  (assign, ":bullet_quiver_count", 0),
                  (assign, ":arrow_type", 0),
                  (assign, ":bullet_type", 0),
                  (assign, ":gren_quiver_count", 0),
                  (assign, ":last_bullet_type", 0),
                  (assign, ":last_arrow_type", 0),
                  (assign, ":first_loop", 0),
                  (assign, ":quiver_is_different", 0), # 1 = 2 types, 2 = 3 types
                  (try_for_range, ":agent_slot_no", 0, 4), #should be 0-4
                    (agent_get_item_slot, ":agent_item_slot_id", ":cur_agent", ":agent_slot_no"),
                    (call_script, "script_get_agent_ammo_type", ":agent_item_slot_id"),
                    (assign, ":quiver_type", reg0), #-1 no, #1 bullets, #2 arrows #3 grenades
                    (assign, ":bullet_type", reg1), #-1 no, #1 bad, #2 norm #3 good
                    (assign, ":arrow_type", reg2), #-1 no, #1 bad, #2 norm #3 good
                    (neq, ":quiver_type", -1),
                    (try_begin),
                      (eq, ":first_loop", 0), #first loop to track last_type
                      (try_begin),
                        (eq, ":quiver_type", 1), #bullets #0-16
                        (assign, ":last_bullet_type", ":bullet_type"),
                        (assign, ":first_loop", 1),
                      (else_try),
                        (eq, ":quiver_type", 2), #Arrows #0-30
                        (assign, ":last_arrow_type", ":arrow_type"),
                        (assign, ":first_loop", 1),
                      (try_end),
                    (else_try), #after first loop, verify bullets or arrows match last quiver type
                      (try_begin),
                        (eq, ":quiver_type", 1), #bullets #0-16
                        (neq, ":bullet_type", ":last_bullet_type"),
                        (assign, ":last_bullet_type", ":bullet_type"),
                        (val_add, ":quiver_is_different", 1),
                      (else_try),
                        (eq, ":quiver_type", 2), #Arrows #0-30
                        (neq, ":arrow_type", ":last_arrow_type"),
                        (assign, ":last_arrow_type", ":arrow_type"),
                        (val_add, ":quiver_is_different", 1),
                      (try_end),
                    (try_end),
                    ...
                    (try_begin),
                      (eq, ":quiver_type", 1), #bullets #0-16
                      (val_add, ":bullet_quiver_count", 1),
                    (else_try),
                      (eq, ":quiver_type", 2), #Arrows #0-30
                      (val_add, ":arrow_quiver_count", 1),
                    (else_try),
                      (eq, ":quiver_type", 3), #Arrows #0-30
                      (val_add, ":gren_quiver_count", 1),
                    (try_end),
                  (try_end),#try for range quiver count end
                  ...
                  (try_for_range, ":agent_slot_no", 0, 4), #should be 0-4
                    ...
                    (try_begin),
                      ...
                      (try_begin),
                        (eq, ":quiver_type", 1), #bullets #0-16
                        (try_begin),
                          (gt, ":bullet_quiver_count", 1),
                          (le, "$g_rearm_interval", 0),
                          (try_begin),
                            (eq, ":quiver_is_different", 1),
                            (gt, ":bullet_quiver_count", 2),
                            (le, "$g_multi_quiver_rearm", 0),
                            (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", 48),
                          (else_try),
                            (eq, ":quiver_is_different", 1),
                            (eq, ":bullet_quiver_count", 2),
                            (val_div, ":agent_slot_ammo_amt", 2),
                            (val_add, ":agent_slot_ammo_amt", 1),
                            (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", ":agent_slot_ammo_amt"),
                          (else_try),
                            (ge, ":quiver_is_different", 2),
                            (le, "$g_multi_quiver_rearm", 0),
                            (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", 48),
                          (else_try),
                            (gt, ":bullet_quiver_count", 1),
                            (eq, ":quiver_is_different", 0),
                            (le, "$g_rearm_interval", 0),
                            (val_add, ":agent_slot_ammo_amt", 1),
                            (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", ":agent_slot_ammo_amt"),
                          (try_end),
                        (else_try),
                          (eq, ":arrow_quiver_count", 1),
                          (eq, ":bullet_quiver_count", 1),
                          (le, "$g_multi_quiver_rearm", 0),
                          (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", 16),
                        (else_try),
                          (eq, ":bullet_quiver_count", 1),
                          (eq, ":quiver_is_different", 0),
                          (eq, ":arrow_quiver_count", 0),
                          (le, "$g_rearm_interval", 0),
                          (val_add, ":agent_slot_ammo_amt", 1),
                          (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", ":agent_slot_ammo_amt"),
                        (try_end),
                      (else_try),
                        (eq, ":quiver_type", 2), #Arrows #0-30
                        (try_begin),
                          (gt, ":arrow_quiver_count", 1),
                          (le, "$g_rearm_interval", 0),
                          (try_begin),
                            (eq, ":quiver_is_different", 1),
                            (gt, ":arrow_quiver_count", 2),
                            (le, "$g_multi_quiver_rearm", 0),
                            (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", 90),
                          (else_try),
                            (eq, ":quiver_is_different", 1),
                            (eq, ":arrow_quiver_count", 2),
                            (val_div, ":agent_slot_ammo_amt", 2),
                            (val_add, ":agent_slot_ammo_amt", 1),
                            (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", ":agent_slot_ammo_amt"),
                          (else_try),
                        ...
                        (else_try),
                          ...
                          (eq, ":bullet_quiver_count", 1),
                          (le, "$g_multi_quiver_rearm", 0),
                          (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", 30),
                        (else_try),
                          (eq, ":arrow_quiver_count", 1),
                          (eq, ":bullet_quiver_count", 0),
                          (le, "$g_rearm_interval", 0),
                          (val_add, ":agent_slot_ammo_amt", 1),
                          (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", ":agent_slot_ammo_amt"),
                        (try_end),
                      (else_try),
                        # DEBUGGER: (assign, reg3, ":gren_quiver_count"), (assign, reg4, "$g_gren_rearm_interval"), (assign, reg5, "$g_gren_rearm_interval_2"), (assign, reg6, "$g_gren_rearm_interval_3"), (assign, reg7, "$g_gren_rearm_interval_4"), (display_message, "@{!}gren_quiver_count {reg3}, g_gren_rearm_interval {reg4}, g_gren_rearm_interval_2 {reg5}, g_gren_rearm_interval_3 {reg6}, g_gren_rearm_interval_4 {reg7}"),
                        (eq, ":quiver_type", 3), #grenade #0-1 #itm_m_granata_small
                        (try_begin),
                          (eq, ":gren_quiver_count", 1),
                          (le, "$g_gren_rearm_interval", 0), #ready for rearm?
                          (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", 1),
                        (else_try),
                          (eq, ":gren_quiver_count", 2),
                          (le, "$g_gren_rearm_interval_2", 0), #ready for rearm?
                          (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", 2),
                        (else_try),
                          (eq, ":gren_quiver_count", 3),
                          (le, "$g_gren_rearm_interval_3", 0), #ready for rearm?
                          (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", 3),
                        (else_try),
                          (eq, ":gren_quiver_count", 4),
                          (le, "$g_gren_rearm_interval_4", 0), #ready for rearm?
                          (agent_set_ammo, ":cur_agent", ":agent_item_slot_id", 4),
                        (try_end),      
                      (try_end),
                    (try_end),
                  (try_end), #try for range slots
                (try_end),
                (ge, ":friendly_total", "$g_global_friendly_count"),  #Break
              (try_end), #try for agents
          (try_end), #try range for props
        (try_end), #try for range prop
          (try_begin),
            (le, "$g_rearm_interval", 0),
            (assign, "$g_rearm_interval", 3),
          (try_end),
          (try_begin),
            (le, "$g_gren_rearm_interval", 0),
            (assign, "$g_gren_rearm_interval", 20),
          (try_end),
          (try_begin),
            (le, "$g_gren_rearm_interval_2", 0),
            (assign, "$g_gren_rearm_interval_2", 30),
          (try_end),
          (try_begin),
            (le, "$g_gren_rearm_interval_3", 0),
            (assign, "$g_gren_rearm_interval_3", 35),
          (try_end),
          (try_begin),
            (le, "$g_gren_rearm_interval_4", 0),
            (assign, "$g_gren_rearm_interval_4", 40),
          (try_end),  
          (try_begin),
            (le, "$g_multi_quiver_rearm", 0),
            (assign, "$g_multi_quiver_rearm", 20),
          (try_end),   
          
      (try_end), #ammo_box verify
      #Daimyo Rearm at Ammo Box END
          ...
          (eq, "$g_daimyo_debug_mode", 1),
					(display_message, "@{!}sending prisoner cart 6 feet underground!"),
					(try_end),
					(set_fixed_point_multiplier, 100), 
					...
					(prop_instance_get_position, pos1, "$g_prison_cart"),
					(position_set_z, pos1, -4000), #40m down
					(prop_instance_set_position, "$g_prison_cart", pos1),	
					(prop_instance_set_position, "$g_prison_cart_left_door", pos1),
					(prop_instance_set_position, "$g_prison_cart_right_door", pos1),
			...
			(else_try),
				...
				#(scene_prop_get_instance, "$g_prison_cart_left_door", "spr_prison_cart_door_left", 0),
				(scene_prop_get_hit_points, ":left_door", "$g_prison_cart_left_door"),
				
				#(scene_prop_get_instance, "$g_prison_cart_right_door", "spr_prison_cart_door_right", 0),
				(scene_prop_get_hit_points, ":right_door", "$g_prison_cart_right_door"),
					#Daimyo broadcast cart killer
				(try_begin),
					(this_or_next|lt, ":left_door", 1),  # left door's broken
					(lt, ":right_door", 1),  # right door's broken
          
          # Daimyo Global Cart Variable to determine cart destroyed
          (assign, "$g_prison_cart_destroyed", 1),	
        ...
        #Daimyo Prison Cart 50% dead
				# if prison cart is not spawned and there is a dead player, then spawn the prison cart
        #(assign, ":dead_count", 0),   #This counts the dead
        #(assign, ":verified_count", 0), #This verifies how many players are active
				(assign, ":is_anyone_dead", 0),
				(try_for_range, ":cur_player", 0, ":max_players"),
					(eq, ":is_anyone_dead", 0),				
					(player_is_active, ":cur_player"),
        ...
        #(try_begin), # Lets see if 50% of the team is dead, if yes then (assign, ":is_anyone_dead", 1),
          #(try_begin),
            #(gt, ":verified_count", 4),
            #(store_div, ":determine_dead", ":verified_count", 2),
            #(ge, ":dead_count", ":determine_dead"),
            #(assign, ":is_anyone_dead", 1),
          #(else_try),
            #(gt, ":dead_count", 0),
            #(assign, ":is_anyone_dead", 1),
        ...
        #(try_end),
          ...
          (try_begin),
          (eq, "$g_daimyo_debug_mode", 1),
					(display_message, "@{!}spawn prison cart 5 secs initiated!"),
          (try_end),
				(try_end),
          ...
          (try_begin),
          (eq, "$g_daimyo_debug_mode", 1),
					(display_message, "@{!}spawn prison cart!"),
          (try_end),
					(try_begin),
			...
			# player&bot spawn management #Daimyo spawn management
			(try_begin),
				(multiplayer_is_server),
				(gt, "$g_multiplayer_ccoop_spawn_player_and_squad_counter", 0),
				(val_sub, "$g_multiplayer_ccoop_spawn_player_and_squad_counter", 1),
				(try_begin),
					(lt, "$g_multiplayer_ccoop_spawn_player_and_squad_counter", 27),
					
			#Despawn Horses For Server Resources ### Start ###
			#(try_for_agents, ":cur_agent"),
      ...
      #   (agent_is_active, ":cur_agent"),
			...
			#	(try_end),
			#(try_end),
			#Despawn Horses For Server Resources ### END ###
			
      #Daimyo Round Carries Over Refill Start
      # refill player and squad health and ammo
        (try_for_agents, ":cur_agent"),
          (agent_is_active, ":cur_agent"),
          (agent_get_team, ":dy_agent_team", ":cur_agent"),
          (agent_is_alive, ":cur_agent"),
          ...
          # refill agent heath and ammo
          (agent_set_hit_points, ":cur_agent", 100, 0),
          (agent_refill_ammo, ":cur_agent"),
          ...
          (try_begin),
            ...
            (agent_is_alive, ":horse_agent"),
            # refill horse health
            (agent_set_hit_points, ":horse_agent", 100, 0),
          #(else_try),
            # if player's horse is dead, we cannot respawn the horse due to restrictions in the engine
          (try_end),
          
        (try_end),
        #Daimyo Round Carries Over REFILL AMMO/HEALTH END
					...
					(try_for_range, ":cur_player", 1, ":max_players"),
						...
						(lt, ":player_team", multi_team_spectator),
						(player_get_agent_id, ":player_agent", ":cur_player"),
						(assign, ":squad_spawned", 0),
            #Daimyo spawn squad bots at cart or spawn normal START
            (try_begin),
             (gt, "$g_multiplayer_ccoop_enemy_respawn_secs", 31),
             (eq, "$g_prison_cart_destroyed", 1),
             (agent_is_alive, ":cur_player"),
             #(neg|lt, ":player_agent", 0),
             (call_script, "script_multiplayer_spawn_player_bot_squad_at_point", ":cur_player", 0, "$g_prison_cart_previous_point"),
             (assign, ":squad_spawned", 1),
            (try_end),
            #Daimyo spawn squad bots at cart or spawn normal END
            ...
            (try_begin),
              ...
              (try_begin),
                (eq, "$g_daimyo_debug_mode", 1),
					...
					(assign, "$g_prison_cart_destroyed", 0),
				(try_end),
