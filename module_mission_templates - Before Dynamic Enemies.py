  ...
  ###############################################
    ...
    [      
      ...
      (try_begin), #Set players horses/damage
        ...
        (try_begin),
          ...
          (try_begin),
            (eq, "$g_disable_horses", 1), 
          (agent_set_max_hit_points, ":hero_players_horse", 0),
         (else_try),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_begin),
            (eq, "$g_disable_horses", 1), 
          (agent_set_max_hit_points, ":reinforcement_agent_horse", 0),
         (else_try),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_begin),
            (eq, "$g_disable_horses", 1), 
          (agent_set_max_hit_points, ":hero_vip_horse", 0),
         (else_try),
      ...
      (assign, "$g_start_server_message_tick", 1), #DY start server message tick
		...
		[
			...
			(assign, "$g_multiplayer_squad_size", 10), # constant size for coop
    ...
    [
      ...
      (try_begin), #Enable or Disable Dynamic Squad Sizes
        ...
        (ge, "$g_multiplayer_ccoop_wave_no", 1),
    ...
    (try_end),
      ...
      #Daimyo Rearm at Ammo Box END
          ...
          (gt, "$g_cart_respawns_count", 0), 
            # respawn all dead players (with some delay)
            (val_sub, "$g_cart_respawns_count", 1),
            ...
            #(assign, "$g_multiplayer_ccoop_spawn_alive_player_squad_and_minus_one_first_spawn_slots_and_minus_one_first_spawn_slots", 0),
          (else_try),
          (le, "$g_cart_respawns_count", 0),
            # respawn all dead players (with some delay)
