...
##    
 ...
 #   ),
    ...
    ("pistol_smoke", psf_billboard_3d|psf_randomize_size, "prtcl_dust_a",
     30, 2.5, 0.6, -0.2, 60.0, 1.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     ...
     0.1                        #emit dir randomness
        ...
        ("oim_pistol_smoke", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation|psf_next_effect_is_lod, "prtcl_dust_a",
     ...
     0.3                        #rotation damping
        ...
        ("oim_pistol_smoke_far", psf_billboard_3d|psf_randomize_size, "prtcl_dust_a",
     80, 5, 11, 0, 6, 60,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     ...
     0.3                        #rotation damping
       ...
       ("oim_pistol_ogon", psf_billboard_3d|psf_randomize_size|psf_next_effect_is_lod, "prt_mesh_fire_1",
      ...
      0.2                       #rotation damping
           ...
           ("oim_pistol_ogon_far", psf_billboard_3d|psf_randomize_size, "prt_mesh_fire_1",
      ...
      0.2                       #rotation damping
        ...
        ("oim_musket_ogon", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation|psf_next_effect_is_lod, "prt_mesh_fire_1",
      ...
      0.2                       #rotation damping
            ...
            ("oim_musket_ogon_far", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
      ...
      0.2                       #rotation damping
            ...
            ("oim_musket_svet", psf_billboard_3d|psf_randomize_size|psf_next_effect_is_lod, "prt_sparks_mesh_1",
        ...
        0.0 #emit dir randomness
                ...
                ("oim_musket_svet_far", psf_billboard_3d|psf_randomize_size, "prt_sparks_mesh_1",
         900, 0.3, 0.6, 0, 10.0, 0.5, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
        (0.0, 0.75), (0.7, 0.2), #alpha keys
        (0.0, 0.75), (1, 0.75), #red keys
        (0.0, 0.5),(1, 0.5),  #green keys
        ...
        0.0 #emit dir randomness
            ...
            ("oim_pistol_svet", psf_billboard_3d|psf_randomize_size|psf_next_effect_is_lod, "prt_sparks_mesh_1",
        900, 0.3, 0.6, 0, 10.0, 0.5, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
        ...
        ("oim_pistol_svet_far", psf_billboard_3d|psf_randomize_size, "prt_sparks_mesh_1",
        900, 0.3, 0.6, 0, 10.0, 0.5, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
        (0.0, 0.5), (0.7, 0.2), #alpha keys
        (0.0, 0.75), (1, 0.75), #red keys
        (0.0, 0.5),(1, 0.5),  #green keys
        ...
        0.0 #emit dir randomness
            ...
            ("oim_pistol_powder_a", psf_billboard_3d|psf_randomize_size|psf_next_effect_is_lod, "prtcl_dust_a",
        ...
        0.2                       #rotation damping
                ...
                ("oim_pistol_powder_a_far", psf_billboard_3d|psf_randomize_size, "prtcl_dust_a",
        500, 4, 17, 0, 5, 40, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
        (0.0, 0.9), (0.75, 0.75),     #alpha keys
        (0.0, 0.95), (1, 0.95),          #red keys
        (0.0, 0.95),(1, 0.95),           #green keys
        ...
        0.2                       #rotation damping
            ...
            ("oim_pistol_powder_b", psf_billboard_3d|psf_randomize_size|psf_next_effect_is_lod, "prt_sparks_mesh_1",
        ...
        0                       #rotation damping
                ...
                ("oim_pistol_powder_b_far", psf_billboard_3d|psf_randomize_size, "prt_sparks_mesh_1",
...
##### Dungeon Water Drops  END #####
	...
	("bomb_fire_2", psf_global_emit_dir|psf_turn_to_velocity, "prt_mesh_fire_2",
     600, 0.2, 0 , 0.0, 0.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     ...
     10000, 3, 6, 0.3, 2.0, 50.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 0.35), (1, 0),        #alpha keys
    ...
    ("bomb_dust", psf_randomize_size|psf_randomize_rotation|psf_billboard_3d, "shrapnel",#prt_mesh_dust_1
     2000, 3,  0, 2, 0, 0, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 1), (1, 1),        #alpha keys
     (0, 0.5), (1, 0.5),        #red keys
     (0, 0.5),(1, 0.5),         #green keys
     (0, 0.5),(1, 0.5),         #blue keys
