...
# Ryan BEGIN
  ("looters", "Looters",icon_axeman|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_looter,3,60)]),
# Ryan END
  ("manhunters", "Marksmen of the Secret Department",icon_player_lord,0,fac_manhunters,soldier_personality,[(trp_manhunter,9,40)]),
...
#  ("black_khergit_raiders","Black Khergit Raiders",icon_khergit_horseman_b|carries_goods(2),0,fac_black_khergits,bandit_personality,[(trp_black_khergit_guard,1,10),(trp_black_khergit_horseman,5,5)]),
  ("steppe_bandits", "Tatar Raiders",icon_tatar_lord|carries_goods(2),0,fac_outlaws,bandit_personality,[(trp_steppe_bandit,3,60)]),
  ("forest_bandits", "Rebels",icon_axeman|carries_goods(2),0,fac_forest_bandits,bandit_personality,[(trp_forest_bandit,3,60)]),
  ("mountain_bandits", "Bandits",icon_axeman|carries_goods(2),0,fac_mountain_bandits,bandit_personality,[(trp_mountain_bandit,3,60)]),
  ("sea_raiders", "Brigands",icon_axeman|carries_goods(2),0,fac_outlaws,bandit_personality,[(trp_sea_raider,3,60)]),

  ("deserters", "Deserters",icon_player_lord|carries_goods(3),0,fac_deserters,bandit_personality,[]),

  ("merchant_caravan", "Merchant Caravan",icon_gray_knight|carries_goods(20)|pf_auto_remove_in_town|pf_quest_party,0,fac_commoners,escorted_merchant_personality,[(trp_caravan_master,1,1),(trp_watchman,10,30)]),
  ("troublesome_bandits", "Troublesome Bandits",icon_player_lord|carries_goods(9)|pf_quest_party,0,fac_oim_outlaws,bandit_personality,[(trp_bandit,14,55)]),
  ("bandits_awaiting_ransom", "Bandits Awaiting Ransom",icon_player_lord|carries_goods(9)|pf_auto_remove_in_town|pf_quest_party,0,fac_neutral,bandit_personality,[(trp_bandit,24,58),(trp_kidnapped_girl,1,1,pmf_is_prisoner)]),
...
##  ("farmers","Farmers",icon_peasant,0,fac_innocents,merchant_personality,[(trp_farmer,11,22),(trp_peasant_woman,16,44)]),
  ("village_farmers", "Metayers",icon_peasant,0,fac_innocents,merchant_personality,[(trp_farmer,5,10),(trp_peasant_woman,3,8)]),
...
##  ("dark_hunters","Dark Hunters",icon_gray_knight,0,fac_dark_knights,soldier_personality,[(trp_dark_knight,4,42),(trp_dark_hunter,13,25)]),
  ...
  ("spy_partners", "Unremarkable Travelers", icon_peasant|carries_goods(3)|pf_default_behavior|pf_quest_party,0,fac_neutral,merchant_personality,[(trp_spy_partner,1,1),(trp_caravan_guard,5,11)]),
  ...
  ("spy", "Ordinary Townsman", icon_peasant|carries_goods(3)|pf_default_behavior|pf_quest_party,0,fac_neutral,merchant_personality,[(trp_spy,1,1)]),
  ("sacrificed_messenger", "Sacrificed Messenger", icon_rp_lord|carries_goods(3)|pf_default_behavior|pf_quest_party,0,fac_neutral,merchant_personality,[]),
...
##  ("noble_refugees", "Noble Refugees", icon_gray_knight|carries_goods(12)|pf_quest_party,0,fac_noble_refugees,merchant_personality,[(trp_noble_refugee,3,5),(trp_noble_refugee_woman,5,7)]),
  ...
  ("forager_party", "Foragers",icon_gray_knight|carries_goods(5)|pf_show_faction,0,fac_commoners,merchant_personality,[]),
...
#  ("war_party", "War Party",icon_gray_knight|carries_goods(3),0,fac_commoners,soldier_personality,[]),
  ("messenger_party", "Messenger",icon_player_lord|pf_show_faction,0,fac_commoners,merchant_personality,[]),
  ...
  ("kingdom_caravan_party", "Caravan",icon_mule|carries_goods(25)|pf_show_faction,0,fac_commoners,merchant_personality,[(trp_caravan_master,1,1),(trp_watchman,12,40)]),
...
# Ozan BEGIN
  ("routed_warriors", "Routed Enemies",icon_axeman,0,fac_commoners,soldier_personality,[]),
# Ozan END
...
# Caravans
  ...
  ("kingdom_hero_party", "War Party",icon_rp_lord|pf_show_faction|pf_default_behavior,0,fac_commoners,soldier_personality,[]),
...
#  ("default_reinforcements_c","default_reinforcements_c",0,0,fac_commoners,0,[(trp_hired_blade,1,7),(trp_mercenary,3,10),(trp_caravan_guard,3,15)]),
  ...
  ("kingdom_1_reinforcements_a", "kingdom 1 reinforcements a", 0, 0, fac_commoners, 0, [(trp_swadian_militia,2,5),(trp_swadian_recruit,3,7)]),
  ("kingdom_1_reinforcements_b", "kingdom 1 reinforcements b", 0, 0, fac_commoners, 0, [(trp_swadian_militia,4,10),(trp_swadian_skirmisher,3,9),(trp_swadian_man_at_arms,1,5)]),
  ("kingdom_1_reinforcements_c", "kingdom 1 reinforcements c", 0, 0, fac_commoners, 0, [(trp_swadian_footman,3,8),(trp_swadian_crossbowman,2,7),(trp_polish_dragoon,1,4),(trp_reestrovuy_kozak,1,2)]),

  ("kingdom_2_reinforcements_a", "kingdom 2 reinforcements a", 0, 0, fac_commoners, 0, [(trp_vaegir_footman,2,8),(trp_vaegir_recruit,3,10)]),
  ("kingdom_2_reinforcements_b", "kingdom 2 reinforcements b", 0, 0, fac_commoners, 0, [(trp_vaegir_footman,5,15),(trp_vaegir_skirmisher,5,15),(trp_vaegir_horseman,1,4)]),
  ("kingdom_2_reinforcements_c", "kingdom 2 reinforcements c", 0, 0, fac_commoners, 0, [(trp_vaegir_veteran,4,12),(trp_vaegir_archer,4,12),(trp_moskow_dragoon,1,3)]),

  ("kingdom_3_reinforcements_a", "kingdom 3 reinforcements a", 0, 0, fac_commoners, 0, [(trp_khergit_tribesman,3,6),(trp_khergit_skirmisher,3,6)]),
  ("kingdom_3_reinforcements_b", "kingdom 3 reinforcements b", 0, 0, fac_commoners, 0, [(trp_khergit_horseman,4,8),(trp_khergit_skirmisher,5,10)]),
  ("kingdom_3_reinforcements_c", "kingdom 3 reinforcements c", 0, 0, fac_commoners, 0, [(trp_khergit_lancer,3,6),(trp_khergit_horse_archer,3,6),(trp_saymen,1,3),(trp_zyndjirli,1,3)]),

  ("kingdom_4_reinforcements_a", "kingdom 4 reinforcements a", 0, 0, fac_commoners, 0, [(trp_nord_footman,1,3),(trp_nord_recruit,2,7)]),
  ("kingdom_4_reinforcements_b", "kingdom 4 reinforcements b", 0, 0, fac_commoners, 0, [(trp_nord_footman,3,9),(trp_nord_huntsman,3,9)]),
  ("kingdom_4_reinforcements_c", "kingdom 4 reinforcements c", 0, 0, fac_commoners, 0, [(trp_nord_trained_footman,2,7),(trp_nord_archer,2,7),(trp_nord_warrior,1,4)]),
...
## OiM template parties 

  ("zamoshie_bandits", "Zamoshye Bandits",icon_peasant|carries_goods(9)|pf_quest_party,0,fac_oim_outlaws,bandit_personality,[(trp_sea_raider,7,9)]),
  ("oim_monfor_party", "Troop of Jaques de Clermont", icon_ewro_lord|carries_goods(3)|pf_default_behavior|pf_quest_party,0,fac_neutral,merchant_personality,[]),
 #pt_oim_swedish_army 
  ("oim_swedish_army", "Swedish Army", icon_ewro_lord|carries_goods(10)|pf_default_behavior|pf_quest_party,0,fac_kingdom_4,soldier_personality,[]),
  
  ("oim_kozak_army", "Cossack Troop", icon_ukr_lord|carries_goods(10)|pf_default_behavior|pf_quest_party,0,fac_kingdom_5,soldier_personality,[]),
  #zagloba party
  ("oim_zagloba_party", "Zagloba's Troop", icon_rp_lord|carries_goods(3)|pf_default_behavior|pf_quest_party,0,fac_outlaws,merchant_personality,[]),
  
  ("oim_potop_mercs_army", "German Mercenaries", icon_ewro_lord|carries_goods(3)|pf_default_behavior|pf_quest_party,0,fac_outlaws,bandit_personality,[]),
  
  ("oim_potop_mercs_army2", "German Mercenaries", icon_ewro_lord|carries_goods(3)|pf_default_behavior|pf_quest_party,0,fac_outlaws,bandit_personality,[]),  
  
  ("getman_deserters", "Deserters", icon_ewro_lord|carries_goods(3)|pf_default_behavior|pf_quest_party,0,fac_outlaws,merchant_personality,[]),
  
  ("oim_merchant_caravan", "Trade Carts",icon_mule|carries_goods(20)|pf_auto_remove_in_town|pf_quest_party,0,fac_commoners,escorted_merchant_personality,[]),
  
  ("oim_merchant_caravan2", "Merchant Caravan",icon_mule|carries_goods(20)|pf_auto_remove_in_town|pf_quest_party,0,fac_commoners,escorted_merchant_personality,[]),
  
  #icon_bridge_b|pf_is_static|pf_always_visible|pf_no_label
  ("oim_static_object", "Do not translate", icon_strat_mogilka|pf_is_static|pf_hide_defenders,0,fac_commoners,merchant_personality,[]),
  
  #("oim_merchant_caravan","Merchant Caravan",icon_gray_knight|carries_goods(20)|pf_auto_remove_in_town|pf_quest_party,0,fac_commoners,escorted_merchant_personality,[(trp_caravan_master,1,1),(trp_watchman,10,30)]),
  
  ###OiM village defenders
  ("village_defenders_fac1", "Village Defenders",icon_peasant,0,fac_commoners,merchant_personality,[(trp_swadian_recruit, 6,7), (trp_swadian_militia, 1,2), (trp_swadian_skirmisher, 2,3),]),
  ("village_defenders_fac2", "Village Defenders",icon_peasant,0,fac_commoners,merchant_personality,[(trp_vaegir_recruit, 7,8), (trp_vaegir_footman, 2,3), (trp_vaegir_skirmisher, 2,3),]),
  ("village_defenders_fac3", "Village Defenders",icon_peasant,0,fac_commoners,merchant_personality,[(trp_khergit_tribesman, 4,9), (trp_khergit_skirmisher, 2,3),  (trp_khergit_horse_archer, 2,3),]),
  ("village_defenders_fac4", "Village Defenders",icon_peasant,0,fac_commoners,merchant_personality,[(trp_nord_recruit, 4,6), (trp_nord_footman, 2,3), (trp_nord_huntsman, 2,3),]),  
  ("village_defenders_fac5", "Village Defenders",icon_peasant,0,fac_commoners,merchant_personality,[(trp_rhodok_tribesman, 2,3), (trp_rhodok_spearman, 2,3),  (trp_rhodok_sergeant, 3,5),]),    
  ## OiM template parties end 
